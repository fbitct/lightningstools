...
public static partial class Speex
{
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = SPEEX_HEADER_STRING_LENGTH)]
        public byte[] speex_string;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = SPEEX_HEADER_VERSION_LENGTH)]
        public byte[] speex_version;
