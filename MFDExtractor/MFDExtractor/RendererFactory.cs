...
namespace MFDExtractor
{
    ...
    internal class RendererFactory : IRendererFactory
    {
        ...
        {
            var gdiPlusOptions = _gdiPlusOptionsReader.Read();
            switch (instrumentType)
            {
                ...
                case InstrumentType.EHSI:
                    return CreateEHSIRenderer(gdiPlusOptions);
                ...
                case InstrumentType.ISIS:
                    return CreateISISRenderer(gdiPlusOptions);
                ...
                case InstrumentType.RWR:
                    return CreateRWRRenderer(gdiPlusOptions);
        ...
        private IAzimuthIndicator CreateRWRRenderer(GdiPlusOptions gdiPlusOptions)
        {
	        return _azimuthIndicatorFactory.Create(gdiPlusOptions);
        }
        ...
        private IEHSI CreateEHSIRenderer(GdiPlusOptions gdiPlusOptions)
        {
            return new EHSI {Options = {GDIPlusOptions = gdiPlusOptions}};
        }
        ...
        private IISIS CreateISISRenderer(GdiPlusOptions gdiPlusOptions)
        {
	        return _isisRendererFactory.Create(gdiPlusOptions);
        }
