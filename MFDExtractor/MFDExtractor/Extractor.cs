...
namespace MFDExtractor
{
    ...
    public sealed class Extractor : IDisposable
    {
        ...
        /// </summary>
        private Bitmap _mfd4BlankImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.rightMFDBlankImage); //TODO: change to MFD4
        /// <summary>
        /// Reference to a bitmap to display when the MFD #3 image data is not available
        /// </summary>
        private Bitmap _mfd3BlankImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.leftMFDBlankImage); //TODO: change to MFD3
        /// <summary>
        /// Reference to a bitmap to display when the Left MFD image data is not available
        /// </summary>
        private Bitmap _leftMfdBlankImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.leftMFDBlankImage);
        /// <summary>
        /// Reference to a bitmap to display when the Right MFD image data is not available
        /// </summary>
        private Bitmap _rightMfdBlankImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.rightMFDBlankImage);
        /// <summary>
        /// Reference to a bitmap to display when the HUD image data is not available
        /// </summary>
        private Bitmap _hudBlankImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.hudBlankImage);
        #endregion
        ...
        /// </summary>
        private Bitmap _mfd4TestAlignmentImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.leftMFDTestAlignmentImage);//TODO: change to MFD4
        /// <summary>
        /// Reference to a bitmap to display when the MFD #3 is in test/alignment mode
        /// </summary>
        private Bitmap _mfd3TestAlignmentImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.leftMFDTestAlignmentImage);//TODO: change to MFD3
        /// <summary>
        /// Reference to a bitmap to display when the Left MFD is in test/alignment mode
        /// </summary>
        private Bitmap _leftMfdTestAlignmentImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.leftMFDTestAlignmentImage);
        /// <summary>
        /// Reference to a bitmap to display when the Right MFD is in test/alignment mode
        /// </summary>
        private Bitmap _rightMfdTestAlignmentImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.rightMFDTestAlignmentImage);
        /// <summary>
        /// Reference to a bitmap to display when the HUD is in test/alignment mode
        /// </summary>
        private Bitmap _hudTestAlignmentImage = Common.Imaging.Util.CloneBitmap(Properties.Resources.hudTestAlignmentImage);
        #endregion
        ...
        private void SendMfd4Image(Bitmap image)
        {
            if (_networkMode == NetworkMode.Server)
            {
        ...
        private void SendMfd3Image(Bitmap image)
        {
            if (_networkMode == NetworkMode.Server)
            {
        ...
        private void SendLeftMfdImage(Bitmap image)
        {
            if (_networkMode == NetworkMode.Server)
            {
        ...
        private void SendRightMfdImage(Bitmap image)
        {
            if (_networkMode == NetworkMode.Server)
            {
        ...
        private void SendHudImage(Bitmap image)
        {
            if (_networkMode == NetworkMode.Server)
            {
        ...
        private Bitmap ReadMfd4FromNetwork()
        {
            Bitmap retrieved = null;
            try
            {
        ...
        private Bitmap ReadMfd3FromNetwork()
        {
            Bitmap retrieved = null;
            try
            {
        ...
        private Bitmap ReadLeftMfdFromNetwork()
        {
            Bitmap retrieved = null;
            try
            {
        ...
        private Bitmap ReadRightMfdFromNetwork()
        {
            Bitmap retrieved = null;
            try
            {
        ...
        private Bitmap ReadHudFromNetwork()
        {
            Bitmap retrieved = null;
            try
            {
        ...
        private Bitmap GetLeftMfdBitmap()
        {
            Bitmap toReturn = null;
            if (_testMode)
            {
        ...
        private Bitmap GetRightMfdBitmap()
        {
            Bitmap toReturn = null;
            if (_testMode)
            {
        ...
        private void SetHudImage(Bitmap hudImage)
        {
                ...
                if (_hudForm != null)
                {
                    ...
                    using (Graphics graphics = _hudForm.CreateGraphics())
                    {
                        if (Properties.Settings.Default.HUD_Monochrome)
                        {
                            ...
                            using (Bitmap compatible = Common.Imaging.Util.CopyBitmap(hudImage))
                            {
        ...
        private void SetMfd4Image(Bitmap mfd4Image)
        {
                ...
                if (_mfd4Form != null)
                {
                    ...
                    using (Graphics graphics = _mfd4Form.CreateGraphics())
                    {
                        if (Properties.Settings.Default.MFD4_Monochrome)
                        {
                            ImageAttributes ia = new ImageAttributes();
                            ia.SetColorMatrix(GetGreyscaleColorMatrix());
                            using (Bitmap compatible = Common.Imaging.Util.CopyBitmap(mfd4Image))
                            {
        ...
        private void SetMfd3Image(Bitmap mfd3Image)
        {
                ...
                if (_mfd3Form != null)
                {
                    ...
                    using (Graphics graphics = _mfd3Form.CreateGraphics())
                    {
                        if (Properties.Settings.Default.MFD3_Monochrome)
                        {
                            ImageAttributes ia = new ImageAttributes();
                            ia.SetColorMatrix(GetGreyscaleColorMatrix());
                            using (Bitmap compatible = Common.Imaging.Util.CopyBitmap(mfd3Image))
                            {
        ...
        private void SetLeftMfdImage(Bitmap leftMfdImage)
        {
                ...
                if (_leftMfdForm != null)
                {
                    ...
                    using (Graphics graphics = _leftMfdForm.CreateGraphics())
                    {
                        if (Properties.Settings.Default.LMFD_Monochrome)
                        {
                            ImageAttributes ia = new ImageAttributes();
                            ia.SetColorMatrix(GetGreyscaleColorMatrix());
                            using (Bitmap compatible = Common.Imaging.Util.CopyBitmap(leftMfdImage))
                            {
        ...
        private void SetRightMfdImage(Bitmap rightMfdImage)
        {
                ...
                if (_rightMfdForm != null)
                {
                    ...
                    using (Graphics graphics = _rightMfdForm.CreateGraphics())
                    {
                        if (Properties.Settings.Default.RMFD_Monochrome)
                        {
                            ImageAttributes ia = new ImageAttributes();
                            ia.SetColorMatrix(GetGreyscaleColorMatrix());
                            using (Bitmap compatible = Common.Imaging.Util.CopyBitmap(rightMfdImage))
                            {
