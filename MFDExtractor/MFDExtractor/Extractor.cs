    ...
    public sealed class Extractor : IDisposable
    {
        ...
        private void CreatePerformanceCounters()
        {
            try
            {
                ...
                var ccds = new[]
                    {
                        new CounterCreationData("MFD4 FPS", "MFD #4 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("MFD3 FPS", "MFD #3 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("LMFD FPS", "Left MFD Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("RMFD FPS", "Right MFD Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("HUD FPS", "HUD Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("ADI FPS", "ADI Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Backup ADI FPS", "Backup ADI Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Airspeed Indicator FPS", "Airspeed Indicator Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Altimeter FPS", "Altimeter Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("AOA Indexer FPS", "AOA Indexer Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("AOA Indicator FPS", "AOA Indicator Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Caution Panel FPS", "Caution Panel Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("CMDS Panel FPS", "CMDS Panel Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Compass FPS", "Compass Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("DED FPS", "DED Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("PFL FPS", "PFL Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("EPU FUEL FPS", "EPU FUEL Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Accelerometer FPS", "Accelerometer Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("FTIT1 FPS", "FTIT1 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("FTIT2 FPS", "FTIT2 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Fuel Flow Indicator FPS", "Fuel Flow Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("ISIS FPS", "ISIS Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Fuel Quantity Indicator FPS",
                                                "Fuel Quantity Indicator Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("HSI FPS", "HSI Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("EHSI FPS", "EHSI Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Landing Gear Lights FPS", "Landing Gear Lights Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("NWS Indexer FPS", "NWS Indexer Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("NOZ1 FPS", "NOZ1 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("NOZ2 FPS", "NOZ2 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Oil1 FPS", "Oil1 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Oil2 FPS", "Oil2 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("RWR FPS", "RWR Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Speedbrake FPS", "Speedbrake Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("RPM1 FPS", "RPM1 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("RPM2 FPS", "RPM2 Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("VVI FPS", "VVI Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("HYD A FPS", "HYD A Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("HYD B FPS", "HYD B Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Cabin Pressure Altitude Indicator FPS",
                                                "Cabin Pressure Altitude Indicator Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Pitch Trim Indicator FPS", "Pitch Trim Indicator Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32),
                        new CounterCreationData("Roll Trim Indicator FPS", "Roll Trim Indicator Frames per Second",
                                                PerformanceCounterType.RateOfCountsPerSecond32)
                    };
                ...
                _cabinPressCounter = new PerformanceCounter(Application.ProductName,
                                                            "Cabin Pressure Altitude Indicator FPS");
