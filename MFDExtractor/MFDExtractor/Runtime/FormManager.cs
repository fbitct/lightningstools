...
namespace MFDExtractor.Runtime
{
    internal class FormManager
    {
        ...
        public void SetupOutputForms()
        {
            ...
            _log.DebugFormat("Started setting up output forms on the extractor at: {0}", startTime);
            ...
            _log.DebugFormat("Finished setting up output forms on the extractor at: {0}", endTime);
