...
namespace MFDExtractor.Runtime
{
    internal class FormManager
    {
        ...
        public void SetupOutputForms()
        {
            ...
            InstrumentFormController.Create("RMFD", "Right MFD", mainForm, BlankAndTestImages.RightMfdBlankImage, new EventHandler((s, e) => { _settingsManager.SaveSettingsAsync(); }), Properties.Settings.Default, _renderers.RMFDRenderer);
