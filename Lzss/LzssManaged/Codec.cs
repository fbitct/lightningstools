...
namespace Lzss
{
    public static class Codec
    {
        ...
        {
            int outputBufferSize = toCompress.Length > DEFAULT_OUTPUT_BUFFER_SIZE
                                   ...
                                   int compressedDataBufferStartingOffset)
        {
            ...
            IntPtr nonCompressedDataBufferStartAddr = Marshal.UnsafeAddrOfPinnedArrayElement(nonCompressedDataBuffer,
                                                                                             nonCompressedDataStartingOffset);
            IntPtr compressedDataBufferStartAddr = Marshal.UnsafeAddrOfPinnedArrayElement(compressedDataBuffer,
                                                                                          compressedDataBufferStartingOffset);
            int compressedDataLength = NativeMethods.LZSS_Compress(nonCompressedDataBufferStartAddr,
                                     ...
                                     int decompressedDataLength)
        {
            ...
            GCHandle gchCompressedDataBuffer = GCHandle.Alloc(compressedDataBuffer);
            IntPtr decompressedDataBufferStartAddr = Marshal.UnsafeAddrOfPinnedArrayElement(decompressedDataBuffer,
                                                                                            decompressedDataStartingOffset);
            IntPtr compressedDataBufferStartAddr = Marshal.UnsafeAddrOfPinnedArrayElement(compressedDataBuffer,
                                                                                          compressedDataBufferStartingOffset);
            int bytesProcessed = NativeMethods.LZSS_Expand(compressedDataBufferStartAddr,
