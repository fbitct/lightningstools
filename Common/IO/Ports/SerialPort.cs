...
namespace Common.IO.Ports
{
    ...
    public class SerialPort : Component, ISerialPort, IDisposable
    {
        ...
        private SerialPort(System.IO.Ports.SerialPort serialPort=null):base()
        {
        ...
        //   System.IO.IOException:
        //     The specified port could not be found or opened.
        public SerialPort(string portName, int baudRate, Parity parity): this(new System.IO.Ports.SerialPort(portName, baudRate, parity)) { }
        //
        // Summary:
        //     Initializes a new instance of the System.IO.Ports.SerialPort class using
        ...
        //   System.IO.IOException:
        //     The specified port could not be found or opened.
        public SerialPort(string portName, int baudRate, Parity parity, int dataBits) : this(new System.IO.Ports.SerialPort(portName, baudRate, parity, dataBits)) { }
        //
        // Summary:
        //     Initializes a new instance of the System.IO.Ports.SerialPort class using
        ...
        //   System.IO.IOException:
        //     The specified port could not be found or opened.
        public SerialPort(string portName, int baudRate, Parity parity, int dataBits, StopBits stopBits) : this(new System.IO.Ports.SerialPort(portName, baudRate, parity, dataBits, stopBits)) { }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool CDHolding { get { return _serialPort.CDHolding; } }
        //
        // Summary:
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool CtsHolding { get { return _serialPort.CtsHolding; } }
        //
        // Summary:
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool DsrHolding { get { return _serialPort.DsrHolding; } }
        //
        // Summary:
...
")]
        ...
        {
            Common.Util.DisposeObject(_serialPort);
