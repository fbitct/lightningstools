...
{
    /// <summary>An abstract base class that provides functionality for the <see cref="T:Common.Drawing.Bitmap" /> and <see cref="T:Common.Drawing.Imaging.Metafile" /> descended classes.</summary>
    ...
    public class Image : MarshalByRefObject, ISerializable, ICloneable, IDisposable
    {
        ...
        /// <summary>Provides a callback method for determining when the <see cref="M:Common.Drawing.Image.GetThumbnailImage(System.Int32,System.Int32,Common.Drawing.Image.GetThumbnailImageAbort,System.IntPtr)" /> method should prematurely cancel execution.</summary>
        /// <returns>This method returns true if it decides that the <see cref="M:Common.Drawing.Image.GetThumbnailImage(System.Int32,System.Int32,Common.Drawing.Image.GetThumbnailImageAbort,System.IntPtr)" /> method should prematurely stop execution; otherwise, it returns false.</returns>
        ...
        public object Tag
        {
            get { return WrappedImage.Tag; }
            set { WrappedImage.Tag = value; }
        }

        /// <summary>Gets the width and height of this image.</summary>
        /// <returns>A <see cref="T:Common.Drawing.SizeF" /> structure that represents the width and height of this <see cref="T:Common.Drawing.Image" />.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ...
        {
            get { return WrappedImage.PhysicalDimension; }
        }

        /// <summary>Gets the width and height, in pixels, of this image.</summary>
        /// <returns>A <see cref="T:Common.Drawing.Size" /> structure that represents the width and height, in pixels, of this image.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        public int Height
        {
            get { return WrappedImage.Height; }
        }
        ...
        {
            get { return WrappedImage.HorizontalResolution; }
        }
        ...
        {
            get { return WrappedImage.VerticalResolution; }
        }

        /// <summary>Gets attribute flags for the pixel data of this <see cref="T:Common.Drawing.Image" />.</summary>
        /// <returns>The integer representing a bitwise combination of <see cref="T:Common.Drawing.Imaging.ImageFlags" /> for this <see cref="T:Common.Drawing.Image" />.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        public int Flags
        {
            get { return WrappedImage.Flags; }
        }

        /// <summary>Gets the file format of this <see cref="T:Common.Drawing.Image" />.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Imaging.ImageFormat" /> that represents the file format of this <see cref="T:Common.Drawing.Image" />.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        {
            get { return WrappedImage.RawFormat; }
        }

        /// <summary>Gets the pixel format for this <see cref="T:Common.Drawing.Image" />.</summary>
        /// <returns>A <see cref="T:Common.Drawing.Imaging.PixelFormat" /> that represents the pixel format for this <see cref="T:Common.Drawing.Image" />.</returns>
        /// <filterpriority>1</filterpriority>
        public PixelFormat PixelFormat
        {
            get { return (PixelFormat)WrappedImage.PixelFormat; }
        }

        /// <summary>Gets or sets the color palette used for this <see cref="T:Common.Drawing.Image" />.</summary>
        /// <returns>A <see cref="T:Common.Drawing.Imaging.ColorPalette" /> that represents the color palette used for this <see cref="T:Common.Drawing.Image" />.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ...
        {
            get { return WrappedImage.Palette; }
            set { WrappedImage.Palette = value; }
        }

        /// <summary>Gets an array of GUIDs that represent the dimensions of frames within this <see cref="T:Common.Drawing.Image" />.</summary>
        /// <returns>An array of GUIDs that specify the dimensions of frames within this <see cref="T:Common.Drawing.Image" /> from most significant to least significant.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        {
            get { return WrappedImage.FrameDimensionsList; }
        }
        ...
        {
            get { return WrappedImage.PropertyIdList; }
        }

        /// <summary>Gets all the property items (pieces of metadata) stored in this <see cref="T:Common.Drawing.Image" />.</summary>
        /// <returns>An array of <see cref="T:Common.Drawing.Imaging.PropertyItem" /> objects, one for each property item stored in the image.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        /// <param name="filename">A string that contains the name of the file from which to create the <see cref="T:Common.Drawing.Image" />. </param>
        ...
        /// <summary>Creates an <see cref="T:Common.Drawing.Image" /> from the specified file using embedded color management information in that file.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Image" /> this method creates.</returns>
        /// <param name="filename">A string that contains the name of the file from which to create the <see cref="T:Common.Drawing.Image" />. </param>
        ...
        /// <returns>The <see cref="T:Common.Drawing.Image" /> this method creates.</returns>
        /// <param name="stream">A <see cref="T:System.IO.Stream" /> that contains the data for this <see cref="T:Common.Drawing.Image" />. </param>
        ...
        /// <summary>Creates an <see cref="T:Common.Drawing.Image" /> from the specified data stream, optionally using embedded color management information in that stream.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Image" /> this method creates.</returns>
        /// <param name="stream">A <see cref="T:System.IO.Stream" /> that contains the data for this <see cref="T:Common.Drawing.Image" />. </param>
        ...
        /// <summary>Creates an <see cref="T:Common.Drawing.Image" /> from the specified data stream, optionally using embedded color management information and validating the image data.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Image" /> this method creates.</returns>
        /// <param name="stream">A <see cref="T:System.IO.Stream" /> that contains the data for this <see cref="T:Common.Drawing.Image" />. </param>
        /// <param name="useEmbeddedColorManagement">true to use color management information embedded in the data stream; otherwise, false. </param>
        ...
        /// <summary>Releases the unmanaged resources used by the <see cref="T:Common.Drawing.Image" /> and optionally releases the managed resources. </summary>
        ...
        /// <returns>An <see cref="T:Common.Drawing.Imaging.EncoderParameters" /> that contains an array of <see cref="T:Common.Drawing.Imaging.EncoderParameter" /> objects. Each <see cref="T:Common.Drawing.Imaging.EncoderParameter" /> contains information about one of the parameters supported by the specified image encoder.</returns>
        ...
        /// <param name="filename">A string that contains the name of the file to which to save this <see cref="T:Common.Drawing.Image" />. </param>
        ...
        /// <param name="filename">A string that contains the name of the file to which to save this <see cref="T:Common.Drawing.Image" />. </param>
        /// <param name="format">The <see cref="T:Common.Drawing.Imaging.ImageFormat" /> for this <see cref="T:Common.Drawing.Image" />. </param>
        /// <exception cref="T:System.ArgumentNullException">
        ...
        /// <summary>Saves this <see cref="T:Common.Drawing.Image" /> to the specified file, with the specified encoder and image-encoder parameters.</summary>
        /// <param name="filename">A string that contains the name of the file to which to save this <see cref="T:Common.Drawing.Image" />. </param>
        /// <param name="encoder">The <see cref="T:Common.Drawing.Imaging.ImageCodecInfo" /> for this <see cref="T:Common.Drawing.Image" />. </param>
        /// <param name="encoderParams">An <see cref="T:Common.Drawing.Imaging.EncoderParameters" /> to use for this <see cref="T:Common.Drawing.Image" />. </param>
        /// <exception cref="T:System.ArgumentNullException">
        ...
        /// <param name="format">An <see cref="T:Common.Drawing.Imaging.ImageFormat" /> that specifies the format of the saved image. </param>
        /// <exception cref="T:System.ArgumentNullException">
        ...
        /// <param name="stream">The <see cref="T:System.IO.Stream" /> where the image will be saved. </param>
        /// <param name="encoder">The <see cref="T:Common.Drawing.Imaging.ImageCodecInfo" /> for this <see cref="T:Common.Drawing.Image" />.</param>
        /// <param name="encoderParams">An <see cref="T:Common.Drawing.Imaging.EncoderParameters" /> that specifies parameters used by the image encoder. </param>
        /// <exception cref="T:System.ArgumentNullException">
        ...
        /// <summary>Adds a frame to the file or stream specified in a previous call to the <see cref="Overload:Common.Drawing.Image.Save" /> method. Use this method to save selected frames from a multiple-frame image to another multiple-frame image.</summary>
        /// <param name="encoderParams">An <see cref="T:Common.Drawing.Imaging.EncoderParameters" /> that holds parameters required by the image encoder that is used by the save-add operation. </param>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        /// <summary>Adds a frame to the file or stream specified in a previous call to the <see cref="Overload:Common.Drawing.Image.Save" /> method.</summary>
        ...
        /// <param name="pageUnit">One of the <see cref="T:Common.Drawing.GraphicsUnit" /> values indicating the unit of measure for the bounding rectangle.</param>
        /// <filterpriority>1</filterpriority>
        public RectangleF GetBounds(ref GraphicsUnit pageUnit)
        {
            System.Drawing.GraphicsUnit pageUnitInternal = (System.Drawing.GraphicsUnit)pageUnit;
        ...
        /// <param name="callback">A <see cref="T:Common.Drawing.Image.GetThumbnailImageAbort" /> delegate. Note   You must create a delegate and pass a reference to the delegate as the <paramref name="callback" /> parameter, but the delegate is not used.</param>
        ...
        /// <param name="dimension">A <see cref="T:Common.Drawing.Imaging.FrameDimension" /> that specifies the identity of the dimension type. </param>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        /// <param name="rotateFlipType">A <see cref="T:Common.Drawing.RotateFlipType" /> member that specifies the type of rotation and flip to apply to the image. </param>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        /// <param name="pixfmt">The <see cref="T:Common.Drawing.Imaging.PixelFormat" /> member that specifies the format for which to find the size. </param>
        /// <filterpriority>1</filterpriority>
        ...
        /// <summary>Returns a value that indicates whether the pixel format for this <see cref="T:Common.Drawing.Image" /> contains alpha information.</summary>
