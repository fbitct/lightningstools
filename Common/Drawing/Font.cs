...
namespace Common.Drawing
{
    ...
    {
        private System.Drawing.Font WrappedFont { get; set; }
        ...
        /// <filterpriority>1</filterpriority>
        [Browsable(false)]
        public FontFamily FontFamily { get { return WrappedFont.FontFamily; } }
        ...
        public bool Bold { get { return WrappedFont.Bold; } }

        /// <summary>Gets a byte value that specifies the GDI character set that this <see cref="T:Common.Drawing.Font" /> uses.</summary>
        /// <returns>A byte value that specifies the GDI character set that this <see cref="T:Common.Drawing.Font" /> uses. The default is 1.</returns>
        /// <filterpriority>1</filterpriority>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public byte GdiCharSet { get { return WrappedFont.GdiCharSet; } }

        /// <summary>Gets a Boolean value that indicates whether this <see cref="T:Common.Drawing.Font" /> is derived from a GDI vertical font.</summary>
        /// <returns>true if this <see cref="T:Common.Drawing.Font" /> is derived from a GDI vertical font; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool GdiVerticalFont { get { return WrappedFont.GdiVerticalFont; } }
        ...
        /// <filterpriority>1</filterpriority>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool Italic { get { return WrappedFont.Italic; } }
        ...
        /// </PermissionSet>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string Name { get { return WrappedFont.Name; } }
        ...
        [Browsable(false)]
        public string OriginalFontName { get { return WrappedFont.OriginalFontName; } }

        /// <summary>Gets a value that indicates whether this <see cref="T:Common.Drawing.Font" /> specifies a horizontal line through the font.</summary>
        /// <returns>true if this <see cref="T:Common.Drawing.Font" /> has a horizontal line through it; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool Strikeout { get { return WrappedFont.Strikeout; } }
        ...
        /// <filterpriority>1</filterpriority>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool Underline { get { return WrappedFont.Underline; } }

        /// <summary>Gets style information for this <see cref="T:Common.Drawing.Font" />.</summary>
        /// <returns>A <see cref="T:Common.Drawing.FontStyle" /> enumeration that contains style information for this <see cref="T:Common.Drawing.Font" />.</returns>
        /// <filterpriority>1</filterpriority>
        [Browsable(false)]
        public FontStyle Style { get { return (FontStyle)WrappedFont.Style; } }

        /// <summary>Gets the em-size of this <see cref="T:Common.Drawing.Font" /> measured in the units specified by the <see cref="P:Common.Drawing.Font.Unit" /> property.</summary>
        /// <returns>The em-size of this <see cref="T:Common.Drawing.Font" />.</returns>
        /// <filterpriority>1</filterpriority>
        public float Size { get { return WrappedFont.Size; } }
        ...
        /// </PermissionSet>
        [Browsable(false)]
        public float SizeInPoints { get { return WrappedFont.SizeInPoints; } }

        /// <summary>Gets the unit of measure for this <see cref="T:Common.Drawing.Font" />.</summary>
        /// <returns>A <see cref="T:Common.Drawing.GraphicsUnit" /> that represents the unit of measure for this <see cref="T:Common.Drawing.Font" />.</returns>
        /// <filterpriority>1</filterpriority>
        public GraphicsUnit Unit { get { return (GraphicsUnit)WrappedFont.Unit; } }
        ...
        /// </PermissionSet>
        [Browsable(false)]
        public int Height { get { return WrappedFont.Height; } }

        /// <summary>Gets a value indicating whether the font is a member of <see cref="T:Common.Drawing.SystemFonts" />. </summary>
        /// <returns>true if the font is a member of <see cref="T:Common.Drawing.SystemFonts" />; otherwise, false. The default is false.</returns>
        [Browsable(false)]
        public bool IsSystemFont { get { return WrappedFont.IsSystemFont; } }

        /// <summary>Gets the name of the system font if the <see cref="P:Common.Drawing.Font.IsSystemFont" /> property returns true.</summary>
        /// <returns>The name of the system font, if <see cref="P:Common.Drawing.Font.IsSystemFont" /> returns true; otherwise, an empty string ("").</returns>
        [Browsable(false)]
        public string SystemFontName { get { return WrappedFont.SystemFontName; } }

        /// <summary>Initializes a new <see cref="T:Common.Drawing.Font" /> that uses the specified existing <see cref="T:Common.Drawing.Font" /> and <see cref="T:Common.Drawing.FontStyle" /> enumeration.</summary>
        /// <param name="prototype">The existing <see cref="T:Common.Drawing.Font" /> from which to create the new <see cref="T:Common.Drawing.Font" />. </param>
        /// <param name="newStyle">The <see cref="T:Common.Drawing.FontStyle" /> to apply to the new <see cref="T:Common.Drawing.Font" />. Multiple values of the <see cref="T:Common.Drawing.FontStyle" /> enumeration can be combined with the OR operator. </param>
        ...
        {
            WrappedFont = new System.Drawing.Font((System.Drawing.FontFamily)family, emSize, (System.Drawing.FontStyle)style, (System.Drawing.GraphicsUnit)unit);
        }
        ...
        {
            WrappedFont = new System.Drawing.Font((System.Drawing.FontFamily)family, emSize, (System.Drawing.FontStyle)style, (System.Drawing.GraphicsUnit)unit, gdiCharSet);
        }
        ...
        {
            WrappedFont = new System.Drawing.Font((System.Drawing.FontFamily)family, emSize, (System.Drawing.FontStyle)style, (System.Drawing.GraphicsUnit)unit, gdiCharSet, gdiVerticalFont);
        }

        /// <summary>Initializes a new <see cref="T:Common.Drawing.Font" /> using a specified size, style, unit, and character set.</summary>
        /// <param name="familyName">A string representation of the <see cref="T:Common.Drawing.FontFamily" /> for the new <see cref="T:Common.Drawing.Font" />. </param>
        /// <param name="emSize">The em-size of the new font in the units specified by the <paramref name="unit" /> parameter. </param>
        /// <param name="style">The <see cref="T:Common.Drawing.FontStyle" /> of the new font. </param>
        /// <param name="unit">The <see cref="T:Common.Drawing.GraphicsUnit" /> of the new font. </param>
        /// <param name="gdiCharSet">A <see cref="T:System.Byte" /> that specifies a GDI character set to use for this font. </param>
        ...
        {
            WrappedFont = new System.Drawing.Font(familyName, emSize, (System.Drawing.FontStyle)style, (System.Drawing.GraphicsUnit)unit, gdiCharSet);
        }

        /// <summary>Initializes a new <see cref="T:Common.Drawing.Font" /> using the specified size, style, unit, and character set.</summary>
        /// <param name="familyName">A string representation of the <see cref="T:Common.Drawing.FontFamily" /> for the new <see cref="T:Common.Drawing.Font" />. </param>
        /// <param name="emSize">The em-size of the new font in the units specified by the <paramref name="unit" /> parameter. </param>
        /// <param name="style">The <see cref="T:Common.Drawing.FontStyle" /> of the new font. </param>
        /// <param name="unit">The <see cref="T:Common.Drawing.GraphicsUnit" /> of the new font. </param>
        /// <param name="gdiCharSet">A <see cref="T:System.Byte" /> that specifies a GDI character set to use for this font. </param>
        /// <param name="gdiVerticalFont">A Boolean value indicating whether the new <see cref="T:Common.Drawing.Font" /> is derived from a GDI vertical font. </param>
        /// <exception cref="T:System.ArgumentException">
        ///   <paramref name="emSize" /> is less than or equal to 0, evaluates to infinity, or is not a valid number. </exception>
        public Font(string familyName, float emSize, FontStyle style, GraphicsUnit unit, byte gdiCharSet, bool gdiVerticalFont)
        {
            WrappedFont = new System.Drawing.Font(familyName, emSize, (System.Drawing.FontStyle)style, (System.Drawing.GraphicsUnit)unit, gdiCharSet, gdiVerticalFont);
        }
        ...
        {
            WrappedFont = new System.Drawing.Font((System.Drawing.FontFamily)family, emSize, (System.Drawing.FontStyle)style);
        }

        /// <summary>Initializes a new <see cref="T:Common.Drawing.Font" /> using a specified size and unit. Sets the style to <see cref="F:Common.Drawing.FontStyle.Regular" />.</summary>
        /// <param name="family">The <see cref="T:Common.Drawing.FontFamily" /> of the new <see cref="T:Common.Drawing.Font" />. </param>
        /// <param name="emSize">The em-size of the new font in the units specified by the <paramref name="unit" /> parameter. </param>
        /// <param name="unit">The <see cref="T:Common.Drawing.GraphicsUnit" /> of the new font. </param>
        /// <exception cref="T:System.ArgumentNullException">
        ...
        {
            WrappedFont = new System.Drawing.Font((System.Drawing.FontFamily)family, emSize, (System.Drawing.GraphicsUnit)unit);
        }
        ...
        {
            WrappedFont = new System.Drawing.Font((System.Drawing.FontFamily)family, emSize);
        }
        ...
        {
            WrappedFont = new System.Drawing.Font(familyName, emSize, (System.Drawing.FontStyle)style,(System.Drawing.GraphicsUnit)unit);
        }
        ...
        /// <summary>Initializes a new <see cref="T:Common.Drawing.Font" /> using a specified size and unit. The style is set to <see cref="F:Common.Drawing.FontStyle.Regular" />.</summary>
        /// <param name="familyName">A string representation of the <see cref="T:Common.Drawing.FontFamily" /> for the new <see cref="T:Common.Drawing.Font" />. </param>
        /// <param name="emSize">The em-size of the new font in the units specified by the <paramref name="unit" /> parameter. </param>
        /// <param name="unit">The <see cref="T:Common.Drawing.GraphicsUnit" /> of the new font. </param>
        /// <exception cref="T:System.ArgumentException">
        ...
        /// <param name="lf">An <see cref="T:System.Object" /> that represents the GDI LOGFONT structure from which to create the <see cref="T:Common.Drawing.Font" />. </param>
        /// <filterpriority>1</filterpriority>
        ...
        /// <returns>true if the <paramref name="obj" /> parameter is a <see cref="T:Common.Drawing.Font" /> and has the same <see cref="P:Common.Drawing.Font.FontFamily" />, <see cref="P:Common.Drawing.Font.GdiVerticalFont" />, <see cref="P:Common.Drawing.Font.GdiCharSet" />, <see cref="P:Common.Drawing.Font.Style" />, <see cref="P:Common.Drawing.Font.Size" />, and <see cref="P:Common.Drawing.Font.Unit" /> property values as this <see cref="T:Common.Drawing.Font" />; otherwise, false.</returns>
        ...
        /// <summary>Creates a GDI logical font (LOGFONT) structure from this <see cref="T:Common.Drawing.Font" />.</summary>
        /// <param name="logFont">An <see cref="T:System.Object" /> that represents the LOGFONT structure that this method creates. </param>
        /// <param name="graphics">A <see cref="T:Common.Drawing.Graphics" /> that provides additional information for the LOGFONT structure. </param>
        /// <exception cref="T:System.ArgumentNullException">
        ...
        /// <summary>Returns the line spacing, in the current unit of a specified <see cref="T:Common.Drawing.Graphics" />, of this font. </summary>
        /// <returns>The line spacing, in pixels, of this font.</returns>
        /// <param name="graphics">A <see cref="T:Common.Drawing.Graphics" /> that holds the vertical resolution, in dots per inch, of the display device as well as settings for page unit and page scale. </param>
        /// <exception cref="T:System.ArgumentNullException">
        ///   <paramref name="graphics" /> is null.</exception>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ...
        /// <summary>Returns the height, in pixels, of this <see cref="T:Common.Drawing.Font" /> when drawn to a device with the specified vertical resolution.</summary>
