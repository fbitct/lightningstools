...
{
    /// <summary>Each property of the <see cref="T:Common.Drawing.SystemColors" /> class is a <see cref="T:Common.Drawing.Color" /> structure that is the color of a Windows display element.</summary>
    ...
    public sealed class SystemColors
    {
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Color" /> structure that is the color of the background of the active window's title bar.</summary>
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Color" /> structure that is the color of the text in the active window's title bar.</summary>
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Color" /> structure that is the lightest color in the color gradient of an active window's title bar.</summary>
        /// <returns>A <see cref="T:Common.Drawing.Color" /> that is the lightest color in the color gradient of an active window's title bar.</returns>
        /// <filterpriority>1</filterpriority>
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Color" /> structure that is the lightest color in the color gradient of an inactive window's title bar.</summary>
        /// <returns>A <see cref="T:Common.Drawing.Color" /> that is the lightest color in the color gradient of an inactive window's title bar.</returns>
        /// <filterpriority>1</filterpriority>
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Color" /> structure that is the color of the background of an inactive window's title bar.</summary>
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Color" /> structure that is the color of the text in an inactive window's title bar.</summary>
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Color" /> structure that is the color used to highlight menu items when the menu appears as a flat menu.</summary>
        /// <returns>A <see cref="T:Common.Drawing.Color" /> that is the color used to highlight menu items when the menu appears as a flat menu.</returns>
        /// <filterpriority>1</filterpriority>
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Color" /> structure that is the color of the background in the client area of a window.</summary>
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Color" /> structure that is the color of the text in the client area of a window.</summary>
