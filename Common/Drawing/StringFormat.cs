...
namespace Common.Drawing
{
    ...
    {
        private System.Drawing.StringFormat WrappedStringFormat { get; set; }
        private StringFormat(System.Drawing.StringFormat stringFormat)
        {
            WrappedStringFormat = stringFormat;
        }

        /// <summary>Gets or sets a <see cref="T:Common.Drawing.StringFormatFlags" /> enumeration that contains formatting information.</summary>
        ...
        {
            get { return (StringFormatFlags)WrappedStringFormat.FormatFlags; }
        ...
        /// <returns>A <see cref="T:Common.Drawing.StringAlignment" /> enumeration that specifies the horizontal  alignment of the string.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        {
            get { return (StringAlignment)WrappedStringFormat.Alignment; }
        ...
        {
            get { return (StringAlignment)WrappedStringFormat.LineAlignment; }
            set { WrappedStringFormat.LineAlignment = (System.Drawing.StringAlignment)value; }
        }

        /// <summary>Gets or sets the <see cref="T:Common.Drawing.Text.HotkeyPrefix" /> object for this <see cref="T:Common.Drawing.StringFormat" /> object.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Text.HotkeyPrefix" /> object for this <see cref="T:Common.Drawing.StringFormat" /> object, the default is <see cref="F:Common.Drawing.Text.HotkeyPrefix.None" />.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        {
            get { return (HotkeyPrefix)WrappedStringFormat.HotkeyPrefix; }
            set { WrappedStringFormat.HotkeyPrefix = (System.Drawing.Text.HotkeyPrefix)value; }
        }

        /// <summary>Gets or sets the <see cref="T:Common.Drawing.StringTrimming" /> enumeration for this <see cref="T:Common.Drawing.StringFormat" /> object.</summary>
        /// <returns>A <see cref="T:Common.Drawing.StringTrimming" /> enumeration that indicates how text drawn with this <see cref="T:Common.Drawing.StringFormat" /> object is trimmed when it exceeds the edges of the layout rectangle.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        {
            get { return (StringTrimming)WrappedStringFormat.Trimming; }
        ...
        {
            get { return System.Drawing.StringFormat.GenericDefault; }
        }
        ...
        {
            get { return System.Drawing.StringFormat.GenericTypographic; }
        }

        /// <summary>Gets the method to be used for digit substitution.</summary>
        /// <returns>A <see cref="T:Common.Drawing.StringDigitSubstitute" /> enumeration value that specifies how to substitute characters in a string that cannot be displayed because they are not supported by the current font.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        /// </PermissionSet>
        ...
        {
            get { return WrappedStringFormat.DigitSubstitutionLanguage; }
        }
        ...
        /// <summary>Initializes a new <see cref="T:Common.Drawing.StringFormat" /> object with the specified <see cref="T:Common.Drawing.StringFormatFlags" /> enumeration.</summary>
        /// <param name="options">The <see cref="T:Common.Drawing.StringFormatFlags" /> enumeration for the new <see cref="T:Common.Drawing.StringFormat" /> object. </param>
        public StringFormat(StringFormatFlags options) 
        {
            WrappedStringFormat = new System.Drawing.StringFormat((System.Drawing.StringFormatFlags)options);
        }

        /// <summary>Initializes a new <see cref="T:Common.Drawing.StringFormat" /> object with the specified <see cref="T:Common.Drawing.StringFormatFlags" /> enumeration and language.</summary>
        /// <param name="options">The <see cref="T:Common.Drawing.StringFormatFlags" /> enumeration for the new <see cref="T:Common.Drawing.StringFormat" /> object. </param>
        ...
        /// <summary>Initializes a new <see cref="T:Common.Drawing.StringFormat" /> object from the specified existing <see cref="T:Common.Drawing.StringFormat" /> object.</summary>
        /// <param name="format">The <see cref="T:Common.Drawing.StringFormat" /> object from which to initialize the new <see cref="T:Common.Drawing.StringFormat" /> object. </param>
        ...
        /// <summary>Specifies an array of <see cref="T:Common.Drawing.CharacterRange" /> structures that represent the ranges of characters measured by a call to the <see cref="M:Common.Drawing.Graphics.MeasureCharacterRanges(System.String,Common.Drawing.Font,Common.Drawing.RectangleF,Common.Drawing.StringFormat)" /> method.</summary>
        /// <param name="ranges">An array of <see cref="T:Common.Drawing.CharacterRange" /> structures that specifies the ranges of characters measured by a call to the <see cref="M:Common.Drawing.Graphics.MeasureCharacterRanges(System.String,Common.Drawing.Font,Common.Drawing.RectangleF,Common.Drawing.StringFormat)" /> method. </param>
        ...
        /// <param name="tabStops">An array of distances between tab stops in the units specified by the <see cref="P:Common.Drawing.Graphics.PageUnit" /> property. </param>
        /// <filterpriority>1</filterpriority>
        ...
        /// <param name="substitute">An element of the <see cref="T:Common.Drawing.StringDigitSubstitute" /> enumeration that specifies how digits are displayed. </param>
        /// <filterpriority>1</filterpriority>
        ...
        /// <summary>Converts the specified <see cref="T:System.Drawing.StringFormat" /> to a <see cref="T:Common.Drawing.StringFormat" />.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.StringFormat" /> to a <see cref="T:System.Drawing.StringFormat" />.</summary>
