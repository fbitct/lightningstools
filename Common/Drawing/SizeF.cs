...
namespace Common.Drawing
{
    ...
    public struct SizeF
    {
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.SizeF" /> structure that has a <see cref="P:Common.Drawing.SizeF.Height" /> and <see cref="P:Common.Drawing.SizeF.Width" /> value of 0. </summary>
        /// <returns>A <see cref="T:Common.Drawing.SizeF" /> structure that has a <see cref="P:Common.Drawing.SizeF.Height" /> and <see cref="P:Common.Drawing.SizeF.Width" /> value of 0.</returns>
        /// <filterpriority>1</filterpriority>
        public static readonly SizeF Empty = System.Drawing.SizeF.Empty;

        /// <summary>Gets a value that indicates whether this <see cref="T:Common.Drawing.SizeF" /> structure has zero width and height.</summary>
        /// <returns>This property returns true when this <see cref="T:Common.Drawing.SizeF" /> structure has both a width and height of zero; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        [Browsable(false)]
        public bool IsEmpty { get { return WrappedSizeF.IsEmpty; } }

        /// <summary>Gets or sets the horizontal component of this <see cref="T:Common.Drawing.SizeF" /> structure.</summary>
        /// <returns>The horizontal component of this <see cref="T:Common.Drawing.SizeF" /> structure, typically measured in pixels.</returns>
        /// <filterpriority>1</filterpriority>
        public float Width
        {
            get { return WrappedSizeF.Width; }
        ...
        public float Height
        {
            get { return WrappedSizeF.Height; }
            set { WrappedSizeF.Height = value; }
        }

        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.SizeF" /> structure from the specified existing <see cref="T:Common.Drawing.SizeF" /> structure.</summary>
        /// <param name="size">The <see cref="T:Common.Drawing.SizeF" /> structure from which to create the new <see cref="T:Common.Drawing.SizeF" /> structure. </param>
        public SizeF(SizeF size)
        {
            WrappedSizeF = new System.Drawing.SizeF(size);
        }

        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.SizeF" /> structure from the specified <see cref="T:Common.Drawing.PointF" /> structure.</summary>
        /// <param name="pt">The <see cref="T:Common.Drawing.PointF" /> structure from which to initialize this <see cref="T:Common.Drawing.SizeF" /> structure. </param>
        public SizeF(PointF pt)
        {
            WrappedSizeF = new System.Drawing.SizeF(pt);
        }

        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.SizeF" /> structure from the specified dimensions.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.SizeF" /> structure to a <see cref="T:System.Drawing.SizeF" /> structure.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:System.Drawing.SizeF" /> structure to a <see cref="T:Common.Drawing.SizeF" /> structure.</summary>
        ...
        /// <summary>Adds the width and height of one <see cref="T:Common.Drawing.SizeF" /> structure to the width and height of another <see cref="T:Common.Drawing.SizeF" /> structure.</summary>
        ...
        /// <summary>Subtracts the width and height of one <see cref="T:Common.Drawing.SizeF" /> structure from the width and height of another <see cref="T:Common.Drawing.SizeF" /> structure.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.SizeF" /> structure to a <see cref="T:Common.Drawing.PointF" /> structure.</summary>
        ...
        /// <summary>Tests to see whether the specified object is a <see cref="T:Common.Drawing.SizeF" /> structure with the same dimensions as this <see cref="T:Common.Drawing.SizeF" /> structure.</summary>
        /// <returns>This method returns true if <paramref name="obj" /> is a <see cref="T:Common.Drawing.SizeF" /> and has the same width and height as this <see cref="T:Common.Drawing.SizeF" />; otherwise, false.</returns>
        ...
        /// <summary>Converts a <see cref="T:Common.Drawing.SizeF" /> structure to a <see cref="T:Common.Drawing.PointF" /> structure.</summary>
        ...
        /// <summary>Converts a <see cref="T:Common.Drawing.SizeF" /> structure to a <see cref="T:Common.Drawing.Size" /> structure.</summary>
