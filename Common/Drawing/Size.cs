...
{
    /// <summary>Stores an ordered pair of integers, which specify a <see cref="P:Common.Drawing.Size.Height" /> and <see cref="P:Common.Drawing.Size.Width" />.</summary>
    ...
    public struct Size
    {
        ...
        /// <summary>Gets a <see cref="T:Common.Drawing.Size" /> structure that has a <see cref="P:Common.Drawing.Size.Height" /> and <see cref="P:Common.Drawing.Size.Width" /> value of 0. </summary>
        /// <returns>A <see cref="T:Common.Drawing.Size" /> that has a <see cref="P:Common.Drawing.Size.Height" /> and <see cref="P:Common.Drawing.Size.Width" /> value of 0.</returns>
        /// <filterpriority>1</filterpriority>
        ...
        /// <returns>This property returns true when this <see cref="T:Common.Drawing.Size" /> structure has both a width and height of 0; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        [Browsable(false)]
        public bool IsEmpty { get { return WrappedSize.IsEmpty; } }
        ...
        public int Height
        {
            get { return WrappedSize.Height; }
            set { WrappedSize.Height = value; }
        }

        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Size" /> structure from the specified <see cref="T:Common.Drawing.Point" /> structure.</summary>
        /// <param name="pt">The <see cref="T:Common.Drawing.Point" /> structure from which to initialize this <see cref="T:Common.Drawing.Size" /> structure. </param>
        public Size(Point pt)
        {
            WrappedSize = new System.Drawing.Size(pt);
        }

        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Size" /> structure from the specified dimensions.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.Size" /> structure to a <see cref="T:System.Drawing.Size" /> structure.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:System.Drawing.Size" /> structure to a <see cref="T:Common.Drawing.Size" /> structure.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.Size" /> structure to a <see cref="T:Common.Drawing.SizeF" /> structure.</summary>
        ...
        /// <summary>Adds the width and height of one <see cref="T:Common.Drawing.Size" /> structure to the width and height of another <see cref="T:Common.Drawing.Size" /> structure.</summary>
        ...
        /// <summary>Subtracts the width and height of one <see cref="T:Common.Drawing.Size" /> structure from the width and height of another <see cref="T:Common.Drawing.Size" /> structure.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.Size" /> structure to a <see cref="T:Common.Drawing.Point" /> structure.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.SizeF" /> structure to a <see cref="T:Common.Drawing.Size" /> structure by rounding the values of the <see cref="T:Common.Drawing.Size" /> structure to the next higher integer values.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.SizeF" /> structure to a <see cref="T:Common.Drawing.Size" /> structure by truncating the values of the <see cref="T:Common.Drawing.SizeF" /> structure to the next lower integer values.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Size" /> structure this method converts to.</returns>
        /// <param name="value">The <see cref="T:Common.Drawing.SizeF" /> structure to convert. </param>
        /// <filterpriority>1</filterpriority>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.SizeF" /> structure to a <see cref="T:Common.Drawing.Size" /> structure by rounding the values of the <see cref="T:Common.Drawing.SizeF" /> structure to the nearest integer values.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Size" /> structure this method converts to.</returns>
        /// <param name="value">The <see cref="T:Common.Drawing.SizeF" /> structure to convert. </param>
        /// <filterpriority>1</filterpriority>
        ...
        /// <summary>Tests to see whether the specified object is a <see cref="T:Common.Drawing.Size" /> structure with the same dimensions as this <see cref="T:Common.Drawing.Size" /> structure.</summary>
        /// <returns>true if <paramref name="obj" /> is a <see cref="T:Common.Drawing.Size" /> and has the same width and height as this <see cref="T:Common.Drawing.Size" />; otherwise, false.</returns>
