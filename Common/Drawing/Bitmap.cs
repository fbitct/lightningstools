namespace Common.Drawing
{
    ...
    public class Bitmap : Image
    {
        ...
        {
            WrappedBitmap = new System.Drawing.Bitmap(width, height, stride, (System.Drawing.Imaging.PixelFormat)format, scan0);
        }
        ...
        {
            return WrappedBitmap.LockBits(rect, (System.Drawing.Imaging.ImageLockMode)flags, (System.Drawing.Imaging.PixelFormat)format);
        }
        
        public virtual BitmapData LockBits(Rectangle rect, ImageLockMode flags, PixelFormat format, BitmapData bitmapData)
        {
            return WrappedBitmap.LockBits(rect, (System.Drawing.Imaging.ImageLockMode)flags, (System.Drawing.Imaging.PixelFormat)format, bitmapData);
        }
