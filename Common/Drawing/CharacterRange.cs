namespace Common.Drawing
{
    ...
    public struct CharacterRange
    {
        ...
        /// <summary>Gets or sets the position in the string of the first character of this <see cref="T:Common.Drawing.CharacterRange" />.</summary>
        /// <returns>The first position of this <see cref="T:Common.Drawing.CharacterRange" />.</returns>
        /// <filterpriority>1</filterpriority>
        public int First
        {
            get { return WrappedCharacterRange.First; }
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.CharacterRange" /> structure, specifying a range of character positions within a string.</summary>
        ...
        /// <returns>true to indicate the specified object is an instance with the same <see cref="P:Common.Drawing.CharacterRange.First" /> and <see cref="P:Common.Drawing.CharacterRange.Length" /> value as this instance; otherwise, false.</returns>
        ...
        /// <summary>Compares two <see cref="T:Common.Drawing.CharacterRange" /> objects. Gets a value indicating whether the <see cref="P:Common.Drawing.CharacterRange.First" /> and <see cref="P:Common.Drawing.CharacterRange.Length" /> values of the two <see cref="T:Common.Drawing.CharacterRange" /> objects are equal.</summary>
        /// <returns>true to indicate the two <see cref="T:Common.Drawing.CharacterRange" /> objects have the same <see cref="P:Common.Drawing.CharacterRange.First" /> and <see cref="P:Common.Drawing.CharacterRange.Length" /> values; otherwise, false. </returns>
        ...
        /// <summary>Compares two <see cref="T:Common.Drawing.CharacterRange" /> objects. Gets a value indicating whether the <see cref="P:Common.Drawing.CharacterRange.First" /> or <see cref="P:Common.Drawing.CharacterRange.Length" /> values of the two <see cref="T:Common.Drawing.CharacterRange" /> objects are not equal.</summary>
        /// <returns>true to indicate the either the <see cref="P:Common.Drawing.CharacterRange.First" /> or <see cref="P:Common.Drawing.CharacterRange.Length" /> values of the two <see cref="T:Common.Drawing.CharacterRange" /> objects differ; otherwise, false. </returns>
        ...
        /// <summary>Converts the specified <see cref="T:System.Drawing.CharacterRange" /> to a <see cref="T:Common.Drawing.CharacterRange" />.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.CharacterRange" /> to a <see cref="T:System.Drawing.CharacterRange" />.</summary>
