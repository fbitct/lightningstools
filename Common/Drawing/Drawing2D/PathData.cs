...
{
    /// <summary>Contains the graphical data that makes up a <see cref="T:Common.Drawing.Drawing2D.GraphicsPath" /> object. This class cannot be inherited.</summary>
    public sealed class PathData
    {
        private System.Drawing.Drawing2D.PathData WrappedPathData { get; set; }
        private PathData(System.Drawing.Drawing2D.PathData pathData)
        {
            WrappedPathData = pathData;
        }
        /// <summary>Gets or sets an array of <see cref="T:Common.Drawing.PointF" /> structures that represents the points through which the path is constructed.</summary>
        ...
        public byte[] Types
        {
            get { return WrappedPathData.Types; }
            set { WrappedPathData.Types = value; }
        }

        /// <summary>Converts the specified <see cref="T:System.Drawing.Drawing2D.PathData" /> to a <see cref="T:Common.Drawing.Drawing2D.PathData" />.</summary>
        ...
        {
            return new PathData(pathData);
        }

        /// <summary>Converts the specified <see cref="T:Common.Drawing.Drawing2D.PathData" /> to a <see cref="T:System.Drawing.Drawing2D.PathData" />.</summary>
