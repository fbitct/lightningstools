namespace Common.Drawing.Drawing2D
{
    ...
    public enum HatchStyle
    {
        ...
        Percent90,
        /// <summary>Specifies diagonal lines that slant to the right from top points to bottom points and are spaced 50 percent closer together than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.ForwardDiagonal" />, but are not antialiased.</summary>
        LightDownwardDiagonal,
        /// <summary>Specifies diagonal lines that slant to the left from top points to bottom points and are spaced 50 percent closer together than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.BackwardDiagonal" />, but they are not antialiased.</summary>
        LightUpwardDiagonal,
        /// <summary>Specifies diagonal lines that slant to the right from top points to bottom points, are spaced 50 percent closer together than, and are twice the width of <see cref="F:Common.Drawing.Drawing2D.HatchStyle.ForwardDiagonal" />. This hatch pattern is not antialiased.</summary>
        DarkDownwardDiagonal,
        /// <summary>Specifies diagonal lines that slant to the left from top points to bottom points, are spaced 50 percent closer together than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.BackwardDiagonal" />, and are twice its width, but the lines are not antialiased.</summary>
        DarkUpwardDiagonal,
        /// <summary>Specifies diagonal lines that slant to the right from top points to bottom points, have the same spacing as hatch style <see cref="F:Common.Drawing.Drawing2D.HatchStyle.ForwardDiagonal" />, and are triple its width, but are not antialiased.</summary>
        WideDownwardDiagonal,
        /// <summary>Specifies diagonal lines that slant to the left from top points to bottom points, have the same spacing as hatch style <see cref="F:Common.Drawing.Drawing2D.HatchStyle.BackwardDiagonal" />, and are triple its width, but are not antialiased.</summary>
        WideUpwardDiagonal,
        /// <summary>Specifies vertical lines that are spaced 50 percent closer together than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.Vertical" />.</summary>
        LightVertical,
        /// <summary>Specifies horizontal lines that are spaced 50 percent closer together than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.Horizontal" />.</summary>
        LightHorizontal,
        /// <summary>Specifies vertical lines that are spaced 75 percent closer together than hatch style <see cref="F:Common.Drawing.Drawing2D.HatchStyle.Vertical" /> (or 25 percent closer together than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.LightVertical" />).</summary>
        NarrowVertical,
        /// <summary>Specifies horizontal lines that are spaced 75 percent closer together than hatch style <see cref="F:Common.Drawing.Drawing2D.HatchStyle.Horizontal" /> (or 25 percent closer together than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.LightHorizontal" />).</summary>
        NarrowHorizontal,
        /// <summary>Specifies vertical lines that are spaced 50 percent closer together than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.Vertical" /> and are twice its width.</summary>
        DarkVertical,
        /// <summary>Specifies horizontal lines that are spaced 50 percent closer together than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.Horizontal" /> and are twice the width of <see cref="F:Common.Drawing.Drawing2D.HatchStyle.Horizontal" />.</summary>
        DarkHorizontal,
        ...
        SmallConfetti,
        /// <summary>Specifies a hatch that has the appearance of confetti, and is composed of larger pieces than <see cref="F:Common.Drawing.Drawing2D.HatchStyle.SmallConfetti" />.</summary>
        LargeConfetti,
        ...
        Sphere,
        /// <summary>Specifies horizontal and vertical lines that cross and are spaced 50 percent closer together than hatch style <see cref="F:Common.Drawing.Drawing2D.HatchStyle.Cross" />.</summary>
        SmallGrid,
        /// <summary>Specifies a hatch that has the appearance of a checkerboard.</summary>
        SmallCheckerBoard,
        /// <summary>Specifies a hatch that has the appearance of a checkerboard with squares that are twice the size of <see cref="F:Common.Drawing.Drawing2D.HatchStyle.SmallCheckerBoard" />.</summary>
        LargeCheckerBoard,
