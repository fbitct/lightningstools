...
{
    /// <summary>The <see cref="T:Common.Drawing.Drawing2D.InterpolationMode" /> enumeration specifies the algorithm that is used when images are scaled or rotated. </summary>
    public enum InterpolationMode
    {
        /// <summary>Equivalent to the <see cref="F:Common.Drawing.Drawing2D.QualityMode.Invalid" /> element of the <see cref="T:System.Drawing.Drawing2D.QualityMode" /> enumeration.</summary>
        Invalid = -1,
