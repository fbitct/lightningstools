...
{
    /// <summary>Represents the internal data of a graphics container. This class is used when saving the state of a <see cref="T:Common.Drawing.Graphics" /> object using the <see cref="M:Common.Drawing.Graphics.BeginContainer" /> and <see cref="M:Common.Drawing.Graphics.EndContainer(Common.Drawing.Drawing2D.GraphicsContainer)" /> methods. This class cannot be inherited.</summary>
    public sealed class GraphicsContainer : MarshalByRefObject
    {
        private System.Drawing.Drawing2D.GraphicsContainer WrappedGraphicsContainer { get; set; }
        ...
        /// <summary>Converts the specified <see cref="T:System.Drawing.Drawing2D.GraphicsContainer" /> to a <see cref="T:Common.Drawing.Drawing2D.GraphicsContainer" />.</summary>
        ...
        {
            return new GraphicsContainer(graphicsContainer);
        }

        /// <summary>Converts the specified <see cref="T:Common.Drawing.Drawing2D.GraphicsContainer" /> to a <see cref="T:System.Drawing.Drawing2D.GraphicsContainer" />.</summary>
