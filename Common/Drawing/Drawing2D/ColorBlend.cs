...
namespace Common.Drawing.Drawing2D
{
    ...
    {
        private System.Drawing.Drawing2D.ColorBlend WrappedColorBlend { get; set; }
        ...
        /// <returns>An array of <see cref="T:Common.Drawing.Color" /> structures that represents the colors to use at corresponding positions along a gradient.</returns>
        public Color[] Colors
        {
            get
            {
                return WrappedColorBlend.Colors.Convert<Color>().ToArray();
            }
            set
            {
                WrappedColorBlend.Colors = value.Convert<System.Drawing.Color>().ToArray();
            }
        }
        ...
        public float[] Positions
        {
            get
            {
                return WrappedColorBlend.Positions;
            }
            set
            {
                WrappedColorBlend.Positions = value;
            }
        }
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Drawing2D.ColorBlend" /> class with the specified number of colors and positions.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:System.Drawing.Drawing2D.ColorBlend" /> to a <see cref="T:Common.Drawing.Drawing2D.ColorBlend" />.</summary>
        ...
        {
            return new ColorBlend(colorBlend);
        }

        /// <summary>Converts the specified <see cref="T:Common.Drawing.Drawing2D.ColorBlend" /> to a <see cref="T:System.Drawing.Drawing2D.ColorBlend" />.</summary>
