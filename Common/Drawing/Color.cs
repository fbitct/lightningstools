...
namespace Common.Drawing
{
    ...
    public struct Color
    {
        private System.Drawing.Color WrappedColor { get; set; }
        ...
        /// </PermissionSet>
        public byte R { get { return WrappedColor.R; } }
        ...
        ///   <IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true" />
        /// </PermissionSet>
        public byte G {  get { return WrappedColor.G; } }
        ...
        ///   <IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true" />
        /// </PermissionSet>
        public byte B { get { return WrappedColor.B; } }
        ...
        ///   <IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true" />
        /// </PermissionSet>
        public byte A { get { return WrappedColor.A; } }

        /// <summary>Gets a value indicating whether this <see cref="T:Common.Drawing.Color" /> structure is a predefined color. Predefined colors are represented by the elements of the <see cref="T:Common.Drawing.KnownColor" /> enumeration.</summary>
        /// <returns>true if this <see cref="T:Common.Drawing.Color" /> was created from a predefined color by using either the <see cref="M:Common.Drawing.Color.FromName(System.String)" /> method or the <see cref="M:Common.Drawing.Color.FromKnownColor(Common.Drawing.KnownColor)" /> method; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        public bool IsKnownColor { get { return WrappedColor.IsKnownColor; } }
        ...
        /// <filterpriority>1</filterpriority>
        public bool IsEmpty { get { return WrappedColor.IsEmpty; } }

        /// <summary>Gets a value indicating whether this <see cref="T:Common.Drawing.Color" /> structure is a named color or a member of the <see cref="T:Common.Drawing.KnownColor" /> enumeration.</summary>
        /// <returns>true if this <see cref="T:Common.Drawing.Color" /> was created by using either the <see cref="M:Common.Drawing.Color.FromName(System.String)" /> method or the <see cref="M:Common.Drawing.Color.FromKnownColor(Common.Drawing.KnownColor)" /> method; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        public bool IsNamedColor { get { return WrappedColor.IsNamedColor; } }

        /// <summary>Gets a value indicating whether this <see cref="T:Common.Drawing.Color" /> structure is a system color. A system color is a color that is used in a Windows display element. System colors are represented by elements of the <see cref="T:Common.Drawing.KnownColor" /> enumeration.</summary>
        /// <returns>true if this <see cref="T:Common.Drawing.Color" /> was created from a system color by using either the <see cref="M:Common.Drawing.Color.FromName(System.String)" /> method or the <see cref="M:Common.Drawing.Color.FromKnownColor(Common.Drawing.KnownColor)" /> method; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        public bool IsSystemColor { get { return WrappedColor.IsSystemColor; } }
        ...
        /// </PermissionSet>
        public string Name { get { return WrappedColor.Name; } }
        ...
        /// <summary>Creates a <see cref="T:Common.Drawing.Color" /> structure from the four ARGB component (alpha, red, green, and blue) values. Although this method allows a 32-bit value to be passed for each component, the value of each component is limited to 8 bits.</summary>
        ...
        /// <summary>Creates a <see cref="T:Common.Drawing.Color" /> structure from the specified <see cref="T:Common.Drawing.Color" /> structure, but with the new specified alpha value. Although this method allows a 32-bit value to be passed for the alpha value, the value is limited to 8 bits.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Color" /> that this method creates.</returns>
        /// <param name="alpha">The alpha value for the new <see cref="T:Common.Drawing.Color" />. Valid values are 0 through 255. </param>
        /// <param name="baseColor">The <see cref="T:Common.Drawing.Color" /> from which to create the new <see cref="T:Common.Drawing.Color" />. </param>
        /// <exception cref="T:System.ArgumentException">
        ...
        /// <summary>Creates a <see cref="T:Common.Drawing.Color" /> structure from the specified 8-bit color values (red, green, and blue). The alpha value is implicitly 255 (fully opaque). Although this method allows a 32-bit value to be passed for each color component, the value of each component is limited to 8 bits.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Color" /> that this method creates.</returns>
        /// <param name="red">The red component value for the new <see cref="T:Common.Drawing.Color" />. Valid values are 0 through 255. </param>
        /// <param name="green">The green component value for the new <see cref="T:Common.Drawing.Color" />. Valid values are 0 through 255. </param>
        /// <param name="blue">The blue component value for the new <see cref="T:Common.Drawing.Color" />. Valid values are 0 through 255. </param>
        /// <exception cref="T:System.ArgumentException">
        ...
        /// <returns>The <see cref="T:Common.Drawing.Color" /> that this method creates.</returns>
        /// <param name="name">A string that is the name of a predefined color. Valid names are the same as the names of the elements of the <see cref="T:Common.Drawing.KnownColor" /> enumeration. </param>
        /// <filterpriority>1</filterpriority>
        ...
        /// <summary>Gets the hue-saturation-brightness (HSB) brightness value for this <see cref="T:Common.Drawing.Color" /> structure.</summary>
        /// <returns>The brightness of this <see cref="T:Common.Drawing.Color" />. The brightness ranges from 0.0 through 1.0, where 0.0 represents black and 1.0 represents white.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true" />
        /// </PermissionSet>
        public float GetBrightness() { return WrappedColor.GetBrightness(); }

        /// <summary>Gets the hue-saturation-brightness (HSB) hue value, in degrees, for this <see cref="T:Common.Drawing.Color" /> structure.</summary>
        /// <returns>The hue, in degrees, of this <see cref="T:Common.Drawing.Color" />. The hue is measured in degrees, ranging from 0.0 through 360.0, in HSB color space.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true" />
        /// </PermissionSet>
        public float GetHue() { return WrappedColor.GetHue(); }

        /// <summary>Gets the hue-saturation-brightness (HSB) saturation value for this <see cref="T:Common.Drawing.Color" /> structure.</summary>
        /// <returns>The saturation of this <see cref="T:Common.Drawing.Color" />. The saturation ranges from 0.0 through 1.0, where 0.0 is grayscale and 1.0 is the most saturated.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true" />
        /// </PermissionSet>
        public float GetSaturation() { return WrappedColor.GetSaturation(); }
        ...
        ///   <IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true" />
        /// </PermissionSet>
        public int ToArgb() { return WrappedColor.ToArgb(); }

        /// <summary>Gets the <see cref="T:Common.Drawing.KnownColor" /> value of this <see cref="T:Common.Drawing.Color" /> structure.</summary>
        /// <returns>An element of the <see cref="T:Common.Drawing.KnownColor" /> enumeration, if the <see cref="T:Common.Drawing.Color" /> is created from a predefined color by using either the <see cref="M:Common.Drawing.Color.FromName(System.String)" /> method or the <see cref="M:Common.Drawing.Color.FromKnownColor(Common.Drawing.KnownColor)" /> method; otherwise, 0.</returns>
        /// <filterpriority>1</filterpriority>
        public KnownColor ToKnownColor() { return (KnownColor)WrappedColor.ToKnownColor(); }

        /// <summary>Converts this <see cref="T:Common.Drawing.Color" /> structure to a human-readable string.</summary>
        /// <returns>A string that is the name of this <see cref="T:Common.Drawing.Color" />, if the <see cref="T:Common.Drawing.Color" /> is created from a predefined color by using either the <see cref="M:Common.Drawing.Color.FromName(System.String)" /> method or the <see cref="M:Common.Drawing.Color.FromKnownColor(Common.Drawing.KnownColor)" /> method; otherwise, a string that consists of the ARGB component names and their values.</returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true" />
        /// </PermissionSet>
        public override string ToString() { return WrappedColor.ToString(); }
        ...
        /// <summary>Tests whether the specified object is a <see cref="T:Common.Drawing.Color" /> structure and is equivalent to this <see cref="T:Common.Drawing.Color" /> structure.</summary>
        /// <returns>true if <paramref name="obj" /> is a <see cref="T:Common.Drawing.Color" /> structure equivalent to this <see cref="T:Common.Drawing.Color" /> structure; otherwise, false.</returns>
