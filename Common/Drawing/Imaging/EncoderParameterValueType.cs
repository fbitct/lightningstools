...
{
    /// <summary>Used to specify the data type of the <see cref="T:Common.Drawing.Imaging.EncoderParameter" /> used with the <see cref="Overload:Common.Drawing.Image.Save" /> or <see cref="Overload:Common.Drawing.Image.SaveAdd" /> method of an image. </summary>
    public enum EncoderParameterValueType
    {
        /// <summary>Specifies that each value in the array is an 8-bit unsigned integer.</summary>
        ValueTypeByte = 1,
        /// <summary>Specifies that the array of values is a null-terminated ASCII character string. Note that the NumberOfValues data member of the <see cref="T:Common.Drawing.Imaging.EncoderParameter" /> object indicates the length of the character string including the NULL terminator.</summary>
        ValueTypeAscii,
