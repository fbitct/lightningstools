...
{
    /// <summary>Used to specify the parameter value passed to a JPEG or TIFF image encoder when using the <see cref="M:Common.Drawing.Image.Save(System.String,Common.Drawing.Imaging.ImageCodecInfo,Common.Drawing.Imaging.EncoderParameters)" /> or <see cref="M:Common.Drawing.Image.SaveAdd(Common.Drawing.Imaging.EncoderParameters)" /> methods.</summary>
