...
{
    /// <summary>Specifies the types of images and colors that will be affected by the color and grayscale adjustment settings of an <see cref="T:Common.Drawing.Imaging.ImageAttributes" />.</summary>
