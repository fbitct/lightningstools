...
namespace Common.Drawing.Imaging
{
    ...
    {
        private System.Drawing.Imaging.PropertyItem WrappedPropertyItem { get; set; }
        ...
        public int Id
        {
            get { return WrappedPropertyItem.Id; }
        ...
        /// <returns>An integer that represents the length (in bytes) of the <see cref="P:Common.Drawing.Imaging.PropertyItem.Value" /> byte array.</returns>
        public int Len
        {
            get { return WrappedPropertyItem.Len; }
            set { WrappedPropertyItem.Len = value; }
        }

        /// <summary>Gets or sets an integer that defines the type of data contained in the <see cref="P:Common.Drawing.Imaging.PropertyItem.Value" /> property.</summary>
        /// <returns>An integer that defines the type of data contained in <see cref="P:Common.Drawing.Imaging.PropertyItem.Value" />.</returns>
        public short Type
        {
            get { return WrappedPropertyItem.Type; }
        ...
        public byte[] Value
        {
            get { return WrappedPropertyItem.Value; }
        ...
        /// <summary>Converts the specified <see cref="T:System.Drawing.Imaging.PropertyItem" /> to a <see cref="T:Common.Drawing.Imaging.PropertyItem" />.</summary>
        ...
        {
            return new PropertyItem(propertyItem);
        }

        /// <summary>Converts the specified <see cref="T:Common.Drawing.Imaging.PropertyItem" /> to a <see cref="T:System.Drawing.Imaging.PropertyItem" />.</summary>
