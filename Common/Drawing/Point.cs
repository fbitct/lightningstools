...
namespace Common.Drawing
{
    ...
    public struct Point
    {
        ...
        /// <summary>Represents a <see cref="T:Common.Drawing.Point" /> that has <see cref="P:Common.Drawing.Point.X" /> and <see cref="P:Common.Drawing.Point.Y" /> values set to zero. </summary>
        /// <filterpriority>1</filterpriority>
        ...
        /// <returns>true if both <see cref="P:Common.Drawing.Point.X" /> and <see cref="P:Common.Drawing.Point.Y" /> are 0; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        [Browsable(false)]
        public bool IsEmpty { get { return WrappedPoint.IsEmpty; } }
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Point" /> class from a <see cref="T:Common.Drawing.Size" />.</summary>
        /// <param name="sz">A <see cref="T:Common.Drawing.Size" /> that specifies the coordinates for the new <see cref="T:Common.Drawing.Point" />. </param>
        public Point(Size sz)
        {
            WrappedPoint = new System.Drawing.Point(sz);
        }

        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Point" /> class using coordinates specified by an integer value.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.Point" /> structure to a <see cref="T:Common.Drawing.PointF" /> structure.</summary>
        ...
        public static implicit operator PointF(Point p) { return (System.Drawing.PointF)p.WrappedPoint; }

        /// <summary>Converts the specified <see cref="T:Common.Drawing.Point" /> structure to a <see cref="T:System.Drawing.Point" /> structure.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:System.Drawing.Point" /> structure to a <see cref="T:Common.Drawing.Point" /> structure.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.Point" /> structure to a <see cref="T:Common.Drawing.Size" /> structure.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Size" /> that results from the conversion.</returns>
        /// <param name="p">The <see cref="T:Common.Drawing.Point" /> to be converted.</param>
        /// <filterpriority>3</filterpriority>
        public static explicit operator Size(Point p) { return (System.Drawing.Size)p.WrappedPoint; }
        ...
        /// <returns>true if the <see cref="P:Common.Drawing.Point.X" /> and <see cref="P:Common.Drawing.Point.Y" /> values of <paramref name="left" /> and <paramref name="right" /> are equal; otherwise, false.</returns>
        ...
        public static Point Add(Point pt, Size sz) { return System.Drawing.Point.Add(pt, sz); }

        /// <summary>Returns the result of subtracting specified <see cref="T:Common.Drawing.Size" /> from the specified <see cref="T:Common.Drawing.Point" />.</summary>
        ...
        public static Point Subtract(Point pt, Size sz) { return System.Drawing.Point.Subtract(pt, sz); }

        /// <summary>Converts the specified <see cref="T:Common.Drawing.PointF" /> to a <see cref="T:Common.Drawing.Point" /> by rounding the values of the <see cref="T:Common.Drawing.PointF" /> to the next higher integer values.</summary>
        ...
        /// <filterpriority>1</filterpriority>
        public static Point Ceiling(PointF value) { return System.Drawing.Point.Ceiling(value); }
        /// <summary>Converts the specified <see cref="T:Common.Drawing.PointF" /> to a <see cref="T:Common.Drawing.Point" /> by truncating the values of the <see cref="T:Common.Drawing.Point" />.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Point" /> this method converts to.</returns>
        /// <param name="value">The <see cref="T:Common.Drawing.PointF" /> to convert. </param>
        /// <filterpriority>1</filterpriority>
        public static Point Truncate(PointF value) { return System.Drawing.Point.Truncate(value); }

        /// <summary>Converts the specified <see cref="T:Common.Drawing.PointF" /> to a <see cref="T:Common.Drawing.Point" /> object by rounding the <see cref="T:Common.Drawing.Point" /> values to the nearest integer.</summary>
        /// <returns>The <see cref="T:Common.Drawing.Point" /> this method converts to.</returns>
        /// <param name="value">The <see cref="T:Common.Drawing.PointF" /> to convert. </param>
        /// <filterpriority>1</filterpriority>
        public static Point Round(PointF value) { return System.Drawing.Point.Round(value); }

        /// <summary>Specifies whether this <see cref="T:Common.Drawing.Point" /> contains the same coordinates as the specified <see cref="T:System.Object" />.</summary>
        /// <returns>true if <paramref name="obj" /> is a <see cref="T:Common.Drawing.Point" /> and has the same coordinates as this <see cref="T:Common.Drawing.Point" />.</returns>
        /// <param name="obj">The <see cref="T:System.Object" /> to test. </param>
        /// <filterpriority>1</filterpriority>
        public override bool Equals(object obj) { return WrappedPoint.Equals(obj); }
        ...
        /// <filterpriority>1</filterpriority>
        public override int GetHashCode() { return WrappedPoint.GetHashCode(); }

        /// <summary>Translates this <see cref="T:Common.Drawing.Point" /> by the specified amount.</summary>
        /// <param name="dx">The amount to offset the x-coordinate. </param>
        /// <param name="dy">The amount to offset the y-coordinate. </param>
        /// <filterpriority>1</filterpriority>
        public void Offset(int dx, int dy) { WrappedPoint.Offset(dx, dy); }
        ...
        public void Offset(Point p) { WrappedPoint.Offset(p); }
        ...
        /// </PermissionSet>
        public override string ToString() { return WrappedPoint.ToString(); }
