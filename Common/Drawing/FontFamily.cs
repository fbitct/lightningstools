...
namespace Common.Drawing
{
    ...
    {
        private System.Drawing.FontFamily WrappedFontFamily { get; set; }
        ...
        /// </PermissionSet>
        public string Name { get { return WrappedFontFamily.Name; } }

        /// <summary>Returns an array that contains all the <see cref="T:Common.Drawing.FontFamily" /> objects associated with the current graphics context.</summary>
        ...
        /// <summary>Initializes a new <see cref="T:Common.Drawing.FontFamily" /> in the specified <see cref="T:Common.Drawing.Text.FontCollection" /> with the specified name.</summary>
        /// <param name="name">A <see cref="T:System.String" /> that represents the name of the new <see cref="T:Common.Drawing.FontFamily" />. </param>
        /// <param name="fontCollection">The <see cref="T:Common.Drawing.Text.FontCollection" /> that contains this <see cref="T:Common.Drawing.FontFamily" />. </param>
        /// <exception cref="T:System.ArgumentException">
        ///   <paramref name="name" /> is an empty string ("").-or-<paramref name="name" /> specifies a font that is not installed on the computer running the application.-or-<paramref name="name" /> specifies a font that is not a TrueType font.</exception>
        ...
        /// <param name="genericFamily">The <see cref="T:Common.Drawing.Text.GenericFontFamilies" /> from which to create the new <see cref="T:Common.Drawing.FontFamily" />. </param>
        ...
        /// <summary>Indicates whether the specified object is a <see cref="T:Common.Drawing.FontFamily" /> and is identical to this <see cref="T:Common.Drawing.FontFamily" />.</summary>
        /// <returns>true if <paramref name="obj" /> is a <see cref="T:Common.Drawing.FontFamily" /> and is identical to this <see cref="T:Common.Drawing.FontFamily" />; otherwise, false.</returns>
        ...
        /// <returns>A <see cref="T:System.String" /> that represents the name, in the specified language, of this <see cref="T:Common.Drawing.FontFamily" />. </returns>
        ...
        /// <summary>Returns an array that contains all the <see cref="T:Common.Drawing.FontFamily" /> objects available for the specified graphics context.</summary>
        /// <returns>An array of <see cref="T:Common.Drawing.FontFamily" /> objects available for the specified <see cref="T:Common.Drawing.Graphics" /> object.</returns>
        /// <param name="graphics">The <see cref="T:Common.Drawing.Graphics" /> object from which to return <see cref="T:Common.Drawing.FontFamily" /> objects. </param>
        ...
        /// <summary>Returns the cell ascent, in design units, of the <see cref="T:Common.Drawing.FontFamily" /> of the specified style.</summary>
        /// <returns>The cell ascent for this <see cref="T:Common.Drawing.FontFamily" /> that uses the specified <see cref="T:Common.Drawing.FontStyle" />.</returns>
        ...
        /// <summary>Returns the cell descent, in design units, of the <see cref="T:Common.Drawing.FontFamily" /> of the specified style. </summary>
        /// <returns>The cell descent metric for this <see cref="T:Common.Drawing.FontFamily" /> that uses the specified <see cref="T:Common.Drawing.FontStyle" />.</returns>
        /// <param name="style">A <see cref="T:Common.Drawing.FontStyle" /> that contains style information for the font. </param>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="UnmanagedCode, ControlEvidence" />
        ...
        /// <summary>Returns the line spacing, in design units, of the <see cref="T:Common.Drawing.FontFamily" /> of the specified style. The line spacing is the vertical distance between the base lines of two consecutive lines of text. </summary>
        ...
        /// <summary>Converts the specified <see cref="T:System.Drawing.FontFamily" /> to a <see cref="T:Common.Drawing.FontFamily" />.</summary>
        ...
        /// <summary>Converts the specified <see cref="T:Common.Drawing.FontFamily" /> to a <see cref="T:System.Drawing.FontFamily" />.</summary>
