...
namespace Common.Drawing
{
    ...
    {
        private System.Drawing.Icon WrappedIcon { get; set; }
        private Icon(System.Drawing.Icon icon)
        {
            WrappedIcon = icon;
        }

        /// <summary>Gets the Windows handle for this <see cref="T:Common.Drawing.Icon" />. This is not a copy of the handle; do not free it.</summary>
        /// <returns>The Windows handle for the icon.</returns>
        /// <filterpriority>1</filterpriority>
        [Browsable(false)]
        public IntPtr Handle
        {
            get { return WrappedIcon.Handle; }
        }
        ...
        public int Height
        {
            get { return WrappedIcon.Height; }
        }

        /// <summary>Gets the size of this <see cref="T:Common.Drawing.Icon" />.</summary>
        /// <returns>A <see cref="T:Common.Drawing.Size" /> structure that specifies the width and height of this <see cref="T:Common.Drawing.Icon" />.</returns>
        /// <filterpriority>1</filterpriority>
        public Size Size
        {
            get { return WrappedIcon.Size; }
        }
        ...
        public Icon(string fileName) { WrappedIcon = new System.Drawing.Icon(fileName); }

        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Icon" /> class of the specified size from the specified file.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Icon" /> class with the specified width and height from the specified file.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Icon" /> class and attempts to find a version of the icon that matches the requested size.</summary>
        /// <param name="original">The <see cref="T:Common.Drawing.Icon" /> from which to load the newly sized icon. </param>
        /// <param name="size">A <see cref="T:Common.Drawing.Size" /> structure that specifies the height and width of the new <see cref="T:Common.Drawing.Icon" />. </param>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Icon" /> class from a resource in the specified assembly.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Icon" /> class of the specified size from the specified stream.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Common.Drawing.Icon" /> class from the specified data stream and with the specified width and height.</summary>
