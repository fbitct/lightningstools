...
namespace Common.MacroProgramming
{
    ...
    internal static class NativeMethods
    {
        ...
        [DllImport("user32.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode, EntryPoint = "MapVirtualKey", SetLastError = true)]
        internal static extern uint MapVirtualKey(uint uCode, MAPVK_MAPTYPES uMapType);
        [DllImport("user32.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode, EntryPoint = "MapVirtualKeyEx", SetLastError = true)]
