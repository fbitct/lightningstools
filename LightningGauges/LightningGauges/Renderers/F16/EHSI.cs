...
namespace LightningGauges.Renderers.F16
{
    ...
    {
        EHSI.EHSIInstrumentState InstrumentState { get; set; }
        EHSI.EHSIOptions Options { get; set; }
    }

    public class EHSI : InstrumentRendererBase, IDisposable, IEHSI
    {
        ...
        public EHSI()
        {
            ...
            InstrumentState = new EHSIInstrumentState();
            Options = new EHSIOptions();
        }
        ...
        public EHSIInstrumentState InstrumentState { get; set; }
        public EHSIOptions Options { get; set; }

        #region Options Class

        public class EHSIOptions
        {
        ...
        [Serializable]
        public class EHSIInstrumentState : InstrumentStateBase
        {
        ...
        private void DrawInstrumentMode(Graphics g, RectangleF outerBounds)
        {
            ...
            if (howLongSinceInstrumentModeChanged.TotalMilliseconds <= 2000)
            {
                ...
                {
                    case EHSIInstrumentState.InstrumentModes.Unknown:
                        break;
                    case EHSIInstrumentState.InstrumentModes.PlsTacan:
                        toDisplay = "PLS/TACAN";
                        break;
                    case EHSIInstrumentState.InstrumentModes.Tacan:
                        toDisplay = "TACAN";
                        break;
                    case EHSIInstrumentState.InstrumentModes.Nav:
                        toDisplay = "NAV";
                        break;
                    case EHSIInstrumentState.InstrumentModes.PlsNav:
                        toDisplay = "PLS/NAV";
                        break;
                    default:
                        break;
            ...
            //draw PLS label
            if (
                InstrumentState.InstrumentMode == EHSIInstrumentState.InstrumentModes.PlsNav
                ||
                InstrumentState.InstrumentMode == EHSIInstrumentState.InstrumentModes.PlsTacan
                )
            {
            ...
            if (
                InstrumentState.InstrumentMode == EHSIInstrumentState.InstrumentModes.PlsNav
                ||
                InstrumentState.InstrumentMode == EHSIInstrumentState.InstrumentModes.Nav
                )
            {
            ...
            if (
                InstrumentState.InstrumentMode == EHSIInstrumentState.InstrumentModes.PlsTacan
                ||
                InstrumentState.InstrumentMode == EHSIInstrumentState.InstrumentModes.Tacan
                )
            {
