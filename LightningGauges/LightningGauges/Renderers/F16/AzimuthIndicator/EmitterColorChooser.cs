...
namespace LightningGauges.Renderers.F16.AzimuthIndicator
{
    ...
    {
        internal static Color GetEmitterColor(Color scopeGreenColor, Color missileColor, Color airborneThreatColor, Color groundThreatColor,
            Color searchThreatColor, Color navalThreatColor, Color unknownThreatColor, Blip blip, Options options)
        {
