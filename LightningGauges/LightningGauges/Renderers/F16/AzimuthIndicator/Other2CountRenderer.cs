...
namespace LightningGauges.Renderers.F16.AzimuthIndicator
{
    ...
    {
        internal static void DrawOther2Count(Color severeColor, Color warnColor, Color okColor, Graphics gfx,
            RectangleF other2CountRectangle, StringFormat chaffFlareCountStringFormat, InstrumentState instrumentState, Font font)
        {
            ...
            StringRenderer.DrawString(gfx, "OTR2", font, other2CountBrush, other2CountRectangle,
                chaffFlareCountStringFormat);
            other2CountRectangle.Offset(0, 12);
            StringRenderer.DrawString(gfx, String.Format("{0:00}", instrumentState.Other2Count), font,
