...
namespace LightningGauges.Renderers.F16.AzimuthIndicator
{
    ...
    {
        internal static void DrawEmitterSymbol(int symbolId, Graphics g, RectangleF bounds, bool largeSize, bool primarySymbol,
            Color color, Font largeFont, Font smallFont, int width)
        {
        ...
        private static PointF[] GetShipSymbolPoints(RectangleF bounds, int width, float x, float y)
        {
            ...
            {
                new PointF(x + 6.5f, -3 + y + (width/4.0f)),
                new PointF(x + 6.5f, -3 + y + 1.5f + (width/4.0f))
                ,
                new PointF(x, -3 + y + 1.5f + (width/4.0f)),
                new PointF(x + 3.5f, -3 + y + 4.5f + (width/4.0f))
                ,
                new PointF(x + 15, -3 + y + 4.5f + (width/4.0f)),
                new PointF(x + 15, -3 + y + 1.5f + (width/4.0f)),
                new PointF(x + 11, -3 + y + 1.5f + (width/4.0f)),
                new PointF(x + 11, -3 + y + (width/4.0f))
            };
