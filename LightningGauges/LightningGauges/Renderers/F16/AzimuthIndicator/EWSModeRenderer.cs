...
namespace LightningGauges.Renderers.F16.AzimuthIndicator
{
    ...
    {
        internal static void DrawEWSMode(Color severeColor, Graphics gfx, RectangleF ewmsModeRectangle, StringFormat miscTextStringFormat, Color warnColor, Color okColor, InstrumentState instrumentState, Font font)
        {
