...
namespace LightningGauges.Renderers.F16.AzimuthIndicator
{
    ...
    {
        internal static void DrawMissileLaunchLine(Graphics gfx, float outerRingTop, float innerRingTop, PointF center, Blip blip,
            Pen launchLinePen, float angle, Brush missileWarningBrush, Options options, Font missileWarningFont)
        {
