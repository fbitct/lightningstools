...
namespace LightningGauges.Renderers.F16.AzimuthIndicator
{
    internal static class PageLegendsRenderer
    {
        internal static void DrawPageLegends(int backgroundHeight, Graphics gfx, InstrumentState instrumentState, Font font)
        {
            ...
            StringRenderer.DrawString(gfx, "TAC", font, Brushes.Black, tacLegendRectangle,
                pageLegendStringFormat);

            //draw non-highlighted SYS legend
            StringRenderer.DrawString(gfx, "SYS", font, Brushes.White, sysLegendRectangle,
                pageLegendStringFormat);
            ...
            if (instrumentState.RWRTest1 || instrumentState.RWRTest2) //Added Falcas 10-11-2012
            {
                ...
                StringRenderer.DrawString(gfx, "TST", font, Brushes.Black, tstLegendRectangle,
                    pageLegendStringFormat);
            }
            else
            {
                //draw non-highlighted TST legend
                StringRenderer.DrawString(gfx, "TST", font, Brushes.White, tstLegendRectangle,
                    pageLegendStringFormat);
            }
        }
    }
