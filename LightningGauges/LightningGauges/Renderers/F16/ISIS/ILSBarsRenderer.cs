...
namespace LightningGauges.Renderers.F16.ISIS
{
    internal static class ILSBarsRenderer
    {
        ...
        internal static void DrawIlsBars(Graphics g, int width, int height, ref GraphicsState basicState, InstrumentState instrumentState)
        {
            ...
            LocalizerCommandBarRenderer.DrawLocalizerCommandBar(g, instrumentState, farLeftLocalizerMarkerCenterPoint, farRightLocalizerMarkerCenterPoint, topGlideSlopeMarkerCenterPoint, bottomGlideSlopeMarkerCenterPoint);

            GlideslopeCommandBarRenderer.DrawGlideslopeCommandBar(g, instrumentState, topGlideSlopeMarkerCenterPoint, bottomGlideSlopeMarkerCenterPoint, farLeftLocalizerMarkerCenterPoint, farRightLocalizerMarkerCenterPoint);
            ...
            GlideslopeMarkersRenderer.DrawGlideslopeMarkers(g, topGlideSlopeMarkerCenterPoint, upperMiddleGlideSlopeMarkerCenterPoint,
                ...
                bottomGlideSlopeMarkerCenterPoint, instrumentState);
            LocalizerMarkersRenderer.DrawLocalizerMarkers(g, farLeftLocalizerMarkerCenterPoint, leftMiddleLocalizerMarkerCenterPoint,
                ...
                rightMiddleLocalizerMarkerCenterPoint, instrumentState);
            GraphicsUtil.RestoreGraphicsState(g, ref basicState);
        }
    }
}