...
namespace LightningGauges.Renderers.F16.ISIS
{
    ...
    {
        internal static void DrawPitchDigits(Graphics g, float pitchLadderWidth, Font pitchDigitFont, Brush pitchDigitBrush,
            StringFormat pitchDigitFormat, float i, float lineWidth, float y)
        {
