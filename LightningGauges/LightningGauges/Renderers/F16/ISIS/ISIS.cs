...
namespace LightningGauges.Renderers.F16.ISIS
{
    ...
    {
        ISIS.ISISOptions Options { get; set; }
        ISIS.ISISInstrumentState InstrumentState { get; set; }
    }
    ...
    public class ISIS : InstrumentRendererBase, IISIS
    {
        ...
        private static ILog _log = LogManager.GetLogger(typeof (ISIS));
        public ISIS()
        {
            InstrumentState = new ISISInstrumentState();
        ...
        public ISISInstrumentState InstrumentState { get; set; }
        ...
        private void DrawBarometricPressureArea(Graphics gfx, ref GraphicsState basicState, RectangleF topRectangle)
        {
            ...
            string units = null;
            if (Options.PressureAltitudeUnits == ISISOptions.PressureUnits.InchesOfMercury)
            {
            ...
            else if (Options.PressureAltitudeUnits == ISISOptions.PressureUnits.Millibars)
            {
        ...
        private void DrawRadarAltimeterArea(Graphics gfx, ref GraphicsState basicState, RectangleF topRectangle)
        {
            ...
            if (Options.RadarAltitudeUnits == ISISOptions.AltitudeUnits.Meters)
            {
                raltString += "m";
            }
            else
        ...
        [Serializable]
        public class ISISInstrumentState : InstrumentStateBase
        {
