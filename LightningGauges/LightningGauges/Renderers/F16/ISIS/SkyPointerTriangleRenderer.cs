...
namespace LightningGauges.Renderers.F16.ISIS
{
    ...
    {
        internal static void DrawSkyPointerTriangle(Graphics g, int width, int height, GraphicsState basicState,
            float rollDegrees, float centerY, float radiusFromCenterToBottomOfIndexLine, Pen rollIndexPen)
        {
