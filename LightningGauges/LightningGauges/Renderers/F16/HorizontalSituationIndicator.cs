...
namespace LightningGauges.Renderers.F16
{
    ...
    {
        HorizontalSituationIndicator.HSIInstrumentState InstrumentState { get; set; }
    }
    ...
    public class HorizontalSituationIndicator : InstrumentRendererBase, IHorizontalSituationIndicator
    {
        ...
        {
            InstrumentState = new HSIInstrumentState();
        }
        ...
        public HSIInstrumentState InstrumentState { get; set; }

        #region Instrument State

        [Serializable]
        public class HSIInstrumentState : InstrumentStateBase
        {
