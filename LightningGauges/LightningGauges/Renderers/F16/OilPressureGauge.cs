...
namespace LightningGauges.Renderers.F16
{
    ...
    public class OilPressureGauge : InstrumentRendererBase, IOilPressureGauge
    {
        ...
        public class OilPressureGaugeInstrumentState : InstrumentStateBase
        {
            ...
            public OilPressureGaugeInstrumentState()
            {
        ...
        {
            public OilPressureGaugeOptions()
            {
                IsSecondary = false;
            }
        ...
        public override void Render(Graphics destinationGraphics, Rectangle destinationRectangle)
        {
            ...
            lock (_imagesLock)
            {
                ...
                {
                    destinationGraphics.DrawImageFast(_background2, new Rectangle(0, 0, _background2.Width, _background2.Height),
