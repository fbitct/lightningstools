...
namespace LightningGauges.Renderers.F16.HSI
{
    ...
    {
        internal static void DrawBearingToBeaconIndicator(Graphics destinationGraphics, ref GraphicsState basicState, float centerX, float centerY, InstrumentState instrumentState, Image hsiBearingToBeaconNeedleMaskedImage)
        {
            //draw the bearing to beacon indicator needle
            GraphicsUtil.RestoreGraphicsState(destinationGraphics, ref basicState);
            destinationGraphics.TranslateTransform(centerX, centerY);
            destinationGraphics.RotateTransform(
