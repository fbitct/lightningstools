...
namespace LightningGauges.Renderers.F16.HSI
{
    ...
    {
        internal static void DrawCourseDeviationIndicator(Graphics destinationGraphics, ref GraphicsState basicState, float centerX, float centerY, InstrumentState instrumentState, Image hsiCourseDeviationIndicatorMaskedImage)
        {
