...
namespace LightningGauges.Renderers
{
    ...
    public class F16AirspeedIndicator : InstrumentRendererBase, IF16AirspeedIndicator
    {
        ...
        {
            InstrumentState = new F16AirspeedIndicatorInstrumentState();
        }
            ...
            if (_background == null)
            {
                _background =
                    ...
                    Util.LoadBitmapFromFile(IMAGES_FOLDER_NAME + Path.DirectorySeparatorChar +
                                            AIRSPEED_BACKGROUND_IMAGE_FILENAME);
            }
            if (_machWheel == null)
            {
        ...
        public F16AirspeedIndicatorInstrumentState InstrumentState { get; set; }
        ...
        public class F16AirspeedIndicatorInstrumentState : InstrumentStateBase
        {
            ...
            public F16AirspeedIndicatorInstrumentState()
            {
