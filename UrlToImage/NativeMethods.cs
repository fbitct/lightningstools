...
namespace UrlToImage
{
    ...
    /// </summary>
    /// <remarks>
    ///   This is implemented through com import, because this 
    ///   custom marshalling ensures correct work, the OLE.Interop implementation 
    ///   seems not to be valid. Please google for more information.
    /// </remarks>
    ...
    public struct DVTARGETDEVICE
    {
        ...
        [MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] public byte[] tdData;
    }
    ...
    public struct LOGPALETTE
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)] public PALETTEENTRY[] palPalEntry;
    }
}