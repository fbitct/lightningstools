...
namespace AnalogDevices
{
    public class DenseDacEvalBoard : IDenseDacEvalBoard
    {
        ...
        private object _controlTransferLock = new object();
        private object _spiPinsStateLock = new object();
        ...
        private ControlRegisterBits ReadbackControlRegister()
        {
            ...
            lock (_controlRegisterLock)
            {
                ...
                {
                    return (ControlRegisterBits)((ushort)_controlRegister.Value & (ushort)ControlRegisterBits.ReadableBits);
                    }
