...
namespace F4Utils.Speech
{
    public class StreamTalk80
    {
        ...
        public struct CODECINFO
        {
           ...
           public string wFormatSubTagName;
        ...
        public struct CODECINFOEX
        {
           ...
           public string szFormatSubTagName;
        ...
        /// </summary>
        [Flags]
        public enum OPENCODERFLAGS:int
        {
        ...
        [DllImport("ST80W.dll", CallingConvention=CallingConvention.StdCall, CharSet=CharSet.Auto, EntryPoint="ST80_Open_Coder", SetLastError=true)]
        public static extern IntPtr OpenCoder( OPENCODERFLAGS dwFlags );

        [DllImport("ST80W.dll", CallingConvention=CallingConvention.StdCall, CharSet=CharSet.Auto, EntryPoint="ST80_Encode", SetLastError=true)]
        public static extern LH_ERRCODE Encode(
              IntPtr hAccess,
              IntPtr inputBufferPtr,
              [In][Out]
              ref Int16 inputBufferLength,
              IntPtr outputBufferPtr,
              [In][Out]
              ref Int16 outputBufferLength
          );

        [DllImport("ST80W.dll", CallingConvention=CallingConvention.StdCall, CharSet=CharSet.Auto, EntryPoint="ST80_Close_Coder", SetLastError=true)]
        public static extern LH_ERRCODE CloseCoder( IntPtr hAccess);

        [DllImport("ST80W.dll", CallingConvention=CallingConvention.StdCall, CharSet=CharSet.Auto, EntryPoint="ST80_Open_Decoder", SetLastError=true)]
        public static extern IntPtr OpenDecoder( OPENCODERFLAGS dwFlags );

        [DllImport("ST80W.dll", CallingConvention=CallingConvention.StdCall, CharSet=CharSet.Auto, EntryPoint="ST80_Decode", SetLastError=true)]
        ...
        [DllImport("ST80W.dll", CallingConvention=CallingConvention.StdCall, CharSet=CharSet.Auto, EntryPoint="ST80_Close_Decoder", SetLastError=true)]
        public static extern LH_ERRCODE CloseDecoder( IntPtr hAccess);

        [DllImport("ST80W.dll", CallingConvention=CallingConvention.StdCall, CharSet=CharSet.Auto, EntryPoint="ST80_GetCodecInfo", SetLastError=true)]
        public static extern void GetCodecInfo([In][Out]ref CODECINFO lpCodecInfo);

        [DllImport("ST80W.dll", CallingConvention=CallingConvention.StdCall, CharSet=CharSet.Auto, EntryPoint="ST80_GetCodecInfoEx", SetLastError=true)]
