...
namespace PPJoy
{
    ...
    public sealed class MappingCollection : IEnumerable, ICollection, IList, ICloneable
    {
        ...
        /// <summary>
        /// Creates a new <see cref="MappingCollection"/> object.
        /// </summary>
        ...
        public MappingCollection ButtonMappings
        {
            get
            {
                return GetAllOfType(typeof(ButtonMapping));
            }
        }
        /// <summary>
        ...
        public MappingCollection PovMappings
        {
            get
            {
                return GetAllOfType(typeof(PovMapping));
            }
        }
        /// <summary>
        ...
        public MappingCollection AxisMappings
        {
            get
            {
                return GetAllOfType(typeof(AxisMapping));
            }
        }
        /// <summary>
        ...
        public Mapping this[int index]
        {
            get
            {
                return (Mapping)((IList)_controls)[index];
            }
            set
            {
                ((IList)_controls)[index] = value;
            }
        }
        /// <summary>
        ...
        {
            get {
                return _controls.IsSynchronized;
            }
        }
        /// <summary>
