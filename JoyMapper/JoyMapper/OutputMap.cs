...
namespace JoyMapper
{
    ...
    public sealed class OutputMap : ICloneable
    {
        ...
        /// </summary>
        /// <param name="mappingFile">a FileInfo object pointing to a file containing
        /// a serialized OutputMap object</param>
        ...
        /// </summary>
        /// <param name="outputFile">a FileInfo object pointing to a file that 
        /// the output map should be saved to</param>
        ...
        /// </summary>
        /// <param name="inputControl">a PhysicalControlInfo object to mark as disabled 
        /// in the output map</param>
        ...
        /// </summary>
        /// <param name="device">PhysicalDeviceInfo object representing the physical 
        /// device whose PhysicalControlInfo objects (representing the device's controls) 
        /// will be marked as 'disabled' in the output map</param>
        public void DisableMapping(PhysicalDeviceInfo device)
        {
            foreach (PhysicalControlInfo control in device.Controls)
            {
        ...
        /// </summary>
        /// <param name="inputControl">a PhysicalControlInfo object to mark as 'enabled' 
        /// in the output map</param>
        ...
        /// <param name="device">PhysicalDeviceInfo object representing the physical 
        /// device whose PhysicalControlInfo objects (representing the device's controls) 
        /// will be marked as 'enabled' in the output map</param>
        ...
        /// </summary>
        /// <param name="device">a PhysicalDeviceInfo object representing a phsyical input device whose control's mappings will be removed from the output map</param>
        ...
        /// </summary>
        /// <param name="inputControl">a PhysicalControlInfo object representing the physical control whose mappings will be removed from the output map</param>
        ...
        /// </summary>
        /// <param name="inputControl">a PhysicalControlInfo object 
        /// representing the source of data (input)</param>
        /// <param name="outputControl">a VirtualControlInfo object representing the target 
        /// (output) for data coming from the specified physical control</param>
        /// <returns>a boolean indicating if the output map has changed as a result 
        ...
        /// modification of the map.</returns>
        ...
        /// </summary>
        /// <param name="inputControl">a PhysicalControlInfo object whose 
        /// corresponding VirtualControlInfo object (if any), will be returned 
        /// from the defined mappings set</param>
        /// <returns>a VirtualControlInfo object representing the virtual control 
        /// which is currently mapped to receive data from the specified 
        /// physical control</returns>
        ...
        /// </summary>
        /// <param name="device">a PhysicalDeviceInfo object representing the physical device
        /// whose mappings set should be retrieved</param>
        /// <returns>a Dictionary<PhysicalControlInfo, VirtualControlInfo>, where the keys 
        ...
        /// </summary>
        /// <returns>a boolean indicating if this output map contains any actual valid output 
        ...
        /// controls (virtual controls) currently appear in the map.</returns>
        public bool ContainsValidMappings()
        {
            bool result = false;
            if (_mappings != null && _mappings.Count > 0)
            {
                foreach (VirtualControlInfo virtualControl in _mappings.Values)
                {
        ...
        /// <param name="device">a PhysicalDeviceInfo object representing the physical device 
        /// to check</param>
        /// <returns>a boolean indicating true if any of the physical controls on the specified 
        /// device are enabled in the output map, or false if none of the physical controls 
        /// on the specified device are enabled in the output map</returns>
        public bool IsMappingEnabled(PhysicalDeviceInfo device)
        {
            foreach (PhysicalControlInfo pci in device.Controls)
            {
        ...
        /// </summary>
        /// <param name="physicalControl">a PhysicalControlInfo object representing the physical input control to check for known mappings</param>
        /// <returns>true if the output map contains any mappings from the specified physical control, or false if it does not contain any mappings from that input control</returns>
        ...
        /// <returns>true, if the output map contains any mappings to the specified virtual data source, or false if the output map does not contain any mappings to the specified virtual data source</returns>
        ...
        /// physical control to check</param>
        /// <returns>a boolean indicating true if the specified physical control is 
        /// enabled in the output map, or false if the specified physical control is 
        /// not enabled (disabled) in the map</returns>
