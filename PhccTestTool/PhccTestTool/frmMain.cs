...
namespace PhccTestTool
{
    public partial class frmMain : Form
    {
        ...
        private ReadOnlyCollection<string> _serialPorts = null;
        private short[] _analogInputs = null;
        private bool[] _digitalInputs = null;
        private bool[] _DOA40DOdigitalOutputs = new bool[40];
        private bool[] _DOB74595TdigitalOutputs = new bool[16];
        private bool _loading = false;
        private Point[] _segmentAPoints = new Point[] { new Point(29, 14), new Point(26, 18), new Point(29, 21), new Point(43, 21), new Point(47, 17), new Point(43, 14) };
        private Point[] _segmentBPoints = new Point[] { new Point(48, 19), new Point(45, 22), new Point(45, 33), new Point(48, 37), new Point(51, 34), new Point(51, 22) };
        private Point[] _segmentCPoints = new Point[] { new Point(48, 40), new Point(45, 43), new Point(45, 54), new Point(48, 57), new Point(51, 54), new Point(51, 43) };
        private Point[] _segmentDPoints = new Point[] { new Point(29, 55), new Point(25, 59), new Point(29, 62), new Point(43, 62), new Point(47, 59), new Point(43, 55) };
        private Point[] _segmentEPoints = new Point[] { new Point(24, 40), new Point(21, 43), new Point(21, 55), new Point(24, 57), new Point(27, 54), new Point(27, 43) };
        private Point[] _segmentFPoints = new Point[] { new Point(24, 19), new Point(21, 22), new Point(21, 33), new Point(24, 36), new Point(27, 33), new Point(27, 22) };
        private Point[] _segmentGPoints = new Point[] { new Point(29, 35), new Point(26, 38), new Point(29, 41), new Point(43, 41), new Point(46, 38), new Point(43, 35) };
        ...
        private TextBox _txtDoa40doDevAddr = null;
        private byte[] _sevenSegBits = new byte[32];
        ...
        private bool ValidateHexTextControl(TextBox textControl, out byte val)
        {
            ...
            if (text.StartsWith("0X"))
            {
                ...
                parsed = Byte.TryParse(text, System.Globalization.NumberStyles.HexNumber, null, out val);
            }
            else
            {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            int displayNum = (int)nudCharLcdDisplayNumber.Value;
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            _sevenSegDecimalPointRectangle= new Rectangle(_sevenSegDecimalPointCenter.X - 3, _sevenSegDecimalPointCenter.Y - 3, 6, 6);
            keyMatrixCardTabs.TabPages.Add("tabDigitalInputs", "Digital Inputs");
            FlowLayoutPanel digitalInputsOuterFlowLayoutPanel = new FlowLayoutPanel();
            ...
            for (int i = 1; i <=16; i++)
            {
                GroupBox gbDigitalInputs = new GroupBox();
                gbDigitalInputs.Name = "gbDigitalInputs" + i.ToString();
                gbDigitalInputs.Text = "KEY" + i.ToString();
                ...
                panel.Name = "digitalInputsKey" + i.ToString() + "FlowLayoutPanel";
                gbDigitalInputs.Controls.Add(panel);
            }

            for (int i = 1; i <= 1024; i++)
            {
                string flowPanelName = "digitalInputsKey" + (((i - 1) / 64) + 1).ToString() +"FlowLayoutPanel";
                string groupBoxName = "gbDigitalInputs" + (((i - 1) / 64) + 1).ToString();
                RadioButton button = new RadioButton();
                button.Name = "rdoDigitalInput" + i.ToString();
                ...
                keyMatrixCardTabs.TabPages["tabDigitalInputs"].Controls["digitalInputsOuterFlowLayoutPanel"].Controls[groupBoxName].Controls[flowPanelName].Controls.Add(button);

                if (i % 16 == 0)
                {
                    ((FlowLayoutPanel)keyMatrixCardTabs.TabPages["tabDigitalInputs"].Controls["digitalInputsOuterFlowLayoutPanel"].Controls[groupBoxName].Controls[flowPanelName]).SetFlowBreak(button, true);
                }
            }

            {
                FlowLayoutPanel digitalOutputsOuterFlowPanel = new FlowLayoutPanel();
                ...
                GroupBox gbDoa40do = new GroupBox();
                gbDoa40do.Text = "DOA_40DO";

                FlowLayoutPanel doa40doFlowPanel = new FlowLayoutPanel();
                ...
                Label lblDoa40doDevAddr = new Label();
                ...
                _txtDoa40doDevAddr.Leave += new EventHandler(txtDoa40doDevAddr_Leave);

                doa40doFlowPanel.Controls.Add(_txtDoa40doDevAddr);
                doa40doFlowPanel.SetFlowBreak(_txtDoa40doDevAddr, true);

                Button cmdDoa40doTurnAllOutputsOn = new Button();
                ...
                cmdDoa40doTurnAllOutputsOn.Click += new EventHandler(cmdDoa40doTurnAllOutputsOn_Click);
                doa40doFlowPanel.Controls.Add(cmdDoa40doTurnAllOutputsOn);
                doa40doFlowPanel.SetFlowBreak(cmdDoa40doTurnAllOutputsOn, false);

                Button cmdDoa40doTurnAllOutputsOff = new Button();
                ...
                cmdDoa40doTurnAllOutputsOff.Click += new EventHandler(cmdDoa40doTurnAllOutputsOff_Click);
                ...
                for (int i = 1; i <= 40; i++)
                {
                    RadioButton doa40doOutputButton = new RadioButton();
                    doa40doOutputButton.Name = "rdoDoa40DoDigitalOutput" + i.ToString();
                    ...
                    doa40doOutputButton.CheckedChanged += new EventHandler(doa40doOutputButton_CheckChanged);
                    doa40doOutputButton.Tag = i;
                    doa40doFlowPanel.Controls.Add(doa40doOutputButton);
                    doa40doOutputButton.Click += new EventHandler(doa40doOutputButton_Click);
                ...
                Label lbldob74595tDevAddr = new Label();
                ...
                TextBox txtDob74595tDevAddr = new TextBox();
                ...
                txtDob74595tDevAddr.Leave += new EventHandler(txtDob74595tDevAddr_Leave);
                ...
                for (int i = 1; i <= 16; i++)
                {
                    RadioButton dob74595tOutputButton = new RadioButton();
                    dob74595tOutputButton.Name = "rdodob74595tDigitalOutput" + i.ToString();
                    ...
                    dob74595tOutputButton.CheckedChanged += new EventHandler(dob74595tOutputButton_CheckedChanged);
            ...
            foreach (var port in _serialPorts)
            {
                ...
                cbSerialPort.Text= port.ToString();
                Application.DoEvents();
            }
            ResetErrors();
        ...
        void cmdDoa40doTurnAllOutputsOff_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < 40; i++)
            {
                RadioButton button = (RadioButton)this.Controls.Find("rdoDoa40DoDigitalOutput" + (i + 1).ToString(), true)[0];

                button.Checked = false;
            }
        }

        void cmdDoa40doTurnAllOutputsOn_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < 40; i++)
            {
                RadioButton button = (RadioButton)this.Controls.Find("rdoDoa40DoDigitalOutput" + (i + 1).ToString(), true)[0];
        ...
        void doa40doOutputButton_Click(object sender, EventArgs e)
        {
            RadioButton digitalOutputButton = ((RadioButton)sender);
            digitalOutputButton.Checked = !digitalOutputButton.Checked;
        }

        void txtDob74595tDevAddr_Leave(object sender, EventArgs e)
        {
            byte val = 0;
            bool valid = ValidateHexTextControl((TextBox)sender, out val);
        }

        void txtDoa40doDevAddr_Leave(object sender, EventArgs e)
        {
            byte val = 0;
            bool valid = ValidateHexTextControl((TextBox)sender, out val);
        ...
        void dob74595tOutputButton_CheckedChanged(object sender, EventArgs e)
        {
            RadioButton digitalOutputButton = ((RadioButton)sender);
        ...
        void doa40doOutputButton_CheckChanged(object sender, EventArgs e)
        {
            RadioButton digitalOutputButton = ((RadioButton)sender);
        ...
        private bool ChangeSerialPort()
        {
            ...
            if (_analogInputs != null)
            {
                for (int i = 0; i <= 2; i++)
                {
                    Control[] controls = this.Controls.Find(string.Format("pbPrioAnalogInput{0:0}", i+1), true);
                    if (controls != null)
                    {
                        ProgressBar control = ((ProgressBar)controls[0]);
                        if (control != null)
                        {
                ...
                {
                    Control[] controls = this.Controls.Find(string.Format("pbAnalogInput{0:0}", i-2), true);
                    if (controls !=null) 
                    {
                        ProgressBar control = ((ProgressBar)controls[0]);
                        if (control != null)
            ...
            if (_digitalInputs != null)
            {
                ...
                {
                    Control[] controls = this.Controls.Find("rdoDigitalInput" + ((i+1).ToString()), true);
                    if (controls != null)
                    {
                        RadioButton control = (RadioButton)controls[0];
            ...
            if (_phccDevice != null && isPhcc)
            {
                _phccDevice.AnalogInputChanged += new AnalogInputChangedEventHandler(_phccDevice_AnalogInputChanged);
                _phccDevice.DigitalInputChanged += new DigitalInputChangedEventHandler(_phccDevice_DigitalInputChanged);
                _phccDevice.I2CDataReceived += new I2CDataReceivedEventHandler(_phccDevice_I2CDataReceived);
            }
            try
            {
                if (_phccDevice != null && isPhcc)
        ...
        void _phccDevice_I2CDataReceived(object sender, I2CDataReceivedEventArgs e)
        {
        ...
        void _phccDevice_DigitalInputChanged(object sender, DigitalInputChangedEventArgs e)
        {
            if (_digitalInputs != null)
            {
                _digitalInputs[e.Index] = e.NewValue;
                Control[] controls = this.Controls.Find("rdoDigitalInput" + ((e.Index + 1).ToString()), true);
                if (controls != null)
                {
                    RadioButton control = (RadioButton)controls[0];
        ...
        void _phccDevice_AnalogInputChanged(object sender, AnalogInputChangedEventArgs e)
        {
            if (_analogInputs != null)
            {
        ...
        private void SendAirCore()
        {
            ...
            if (_phccDevice != null && !String.IsNullOrEmpty(_phccDevice.PortName))
            {
                try
                {
                    _phccDevice.DoaSendAirCoreMotor(devAddr, 1, (int)tbAirCore1.Value);
                    _phccDevice.DoaSendAirCoreMotor(devAddr, 2, (int)tbAirCore2.Value);
                    _phccDevice.DoaSendAirCoreMotor(devAddr, 3, (int)tbAirCore3.Value);
                    _phccDevice.DoaSendAirCoreMotor(devAddr, 4, (int)tbAirCore4.Value);
                }
                catch (Exception ex)
                {
                    Debug.WriteLine(ex);
        ...
        private void RenderNeedleGauge(PictureBox pb, int value, int scaleMin, int scaleMax, int degrees)
        {
            ...
            using (Graphics g = Graphics.FromImage(pb.Image))
            {
                ...
                float pct = (float)((float)value / (float)scaleMax);
        ...
        private void render7Seg(PictureBox pb, byte bits)
        {
            ...
            using (Graphics g = Graphics.FromImage(pb.Image))
            {
                ...
                if ((bits & (byte) Phcc.SevenSegmentBits.SegmentDP) == (byte)Phcc.SevenSegmentBits.SegmentDP)
                {
                    g.FillEllipse(greenBrush, _sevenSegDecimalPointRectangle);
                }
                if ((bits & (byte)Phcc.SevenSegmentBits.SegmentA) == (byte)Phcc.SevenSegmentBits.SegmentA)
                {
                    g.FillPolygon(greenBrush, _segmentAPoints);
                }
                if ((bits & (byte)Phcc.SevenSegmentBits.SegmentB) == (byte)Phcc.SevenSegmentBits.SegmentB)
                {
                    g.FillPolygon(greenBrush, _segmentBPoints);
                }
                if ((bits & (byte)Phcc.SevenSegmentBits.SegmentC) == (byte)Phcc.SevenSegmentBits.SegmentC)
                {
                    g.FillPolygon(greenBrush, _segmentCPoints);
                }
                if ((bits & (byte)Phcc.SevenSegmentBits.SegmentD) == (byte)Phcc.SevenSegmentBits.SegmentD)
                {
                    g.FillPolygon(greenBrush, _segmentDPoints);
                }
                if ((bits & (byte)Phcc.SevenSegmentBits.SegmentE) == (byte)Phcc.SevenSegmentBits.SegmentE)
                {
                    g.FillPolygon(greenBrush, _segmentEPoints);
                }
                if ((bits & (byte)Phcc.SevenSegmentBits.SegmentF) == (byte)Phcc.SevenSegmentBits.SegmentF)
                {
                    g.FillPolygon(greenBrush, _segmentFPoints);
                }
                if ((bits & (byte)Phcc.SevenSegmentBits.SegmentG) == (byte)Phcc.SevenSegmentBits.SegmentG)
                {
        ...
        private void Evaluate7SegPicBoxClick(PictureBox pb, Point clickLocation, int displayNum)
        {
            ...
            System.Collections.BitArray bits = new System.Collections.BitArray(new byte[] { currentBits });
        ...
        private void cmdMoveStepper1_Click(object sender, EventArgs e)
        {
            ...
            if (_phccDevice != null && !String.IsNullOrEmpty(_phccDevice.PortName))
            {
                try
                {
                    _phccDevice.DoaSendStepperMotor(devAddr, 1, direction, (byte)(nudStepper1NumSteps.Value - 1), stepType);
                }
                catch (Exception ex)
                {
                    Debug.WriteLine(ex);
        ...
        private void cmdMoveStepper2_Click(object sender, EventArgs e)
        {
            ...
            if (_phccDevice != null && !String.IsNullOrEmpty(_phccDevice.PortName))
            {
                try
                {
                    _phccDevice.DoaSendStepperMotor(devAddr, 2, direction, (byte)(nudStepper2NumSteps.Value - 1), stepType);
                }
                catch (Exception ex)
                {
                    Debug.WriteLine(ex);
        ...
        private void cmdMoveStepper3_Click(object sender, EventArgs e)
        {
            ...
            if (_phccDevice != null && !String.IsNullOrEmpty(_phccDevice.PortName))
            {
                try
                {
                    _phccDevice.DoaSendStepperMotor(devAddr, 3, direction, (byte)(nudStepper3NumSteps.Value - 1), stepType);
                }
                catch (Exception ex)
                {
                    Debug.WriteLine(ex);
        ...
        private void cmdMoveStepper4_Click(object sender, EventArgs e)
        {
            ...
            if (_phccDevice != null && !String.IsNullOrEmpty(_phccDevice.PortName))
            {
                try
                {
                    _phccDevice.DoaSendStepperMotor(devAddr, 4, direction, (byte)(nudStepper4NumSteps.Value - 1), stepType);
                }
                catch (Exception ex)
                {
                    Debug.WriteLine(ex);
        ...
        private void txt7Seg1thru8String_TextChanged(object sender, EventArgs e)
        {
            ...
            if (contents != null)
            {
                for (int i = 0; i < 8; i++)
                {
                    ...
                    {
                        _sevenSegBits[i] = new Phcc.Device().CharTo7Seg(contents[i]);
                    }
                    else
                    {
                        _sevenSegBits[i] = (byte)Phcc.SevenSegmentBits.None;
                    }
                }
            }
            render7Seg(pbSevenSegDisplay1, _sevenSegBits[0]);
        ...
        private void txt7Seg9thru16String_TextChanged(object sender, EventArgs e)
        {
            ...
            if (contents != null)
            {
                for (int i = 0; i < 8; i++)
                {
                    if (contents.Length >= (i + 1))
                    {
                        _sevenSegBits[i+8] = new Phcc.Device().CharTo7Seg(contents[i]);
                    }
                    else
                    {
                        _sevenSegBits[i+8] = (byte)Phcc.SevenSegmentBits.None;
                    }
                }
            }
            render7Seg(pbSevenSegDisplay9, _sevenSegBits[8]);
        ...
        private void txt7Seg17thru24String_TextChanged(object sender, EventArgs e)
        {
            ...
            if (contents != null)
            {
                for (int i = 0; i < 8; i++)
                {
                    if (contents.Length >= (i + 1))
                    {
                        _sevenSegBits[i + 16] = new Phcc.Device().CharTo7Seg(contents[i]);
                    }
                    else
                    {
                        _sevenSegBits[i + 16] = (byte)Phcc.SevenSegmentBits.None;
                    }
                }
            }
            render7Seg(pbSevenSegDisplay17, _sevenSegBits[16]);
        ...
        private void txt7Seg25thru32String_TextChanged(object sender, EventArgs e)
        {
            ...
            if (contents != null)
            {
                for (int i = 0; i < 8; i++)
                {
                    if (contents.Length >= (i + 1))
                    {
                        _sevenSegBits[i + 24] = new Phcc.Device().CharTo7Seg(contents[i]);
                    }
                    else
                    {
                        _sevenSegBits[i + 24] = (byte)Phcc.SevenSegmentBits.None;
                    }
                }
            }
            render7Seg(pbSevenSegDisplay25, _sevenSegBits[24]);
        ...
        private void ResetErrors()
        {
            ...
            {
                epErrorProvider.BlinkStyle = ErrorBlinkStyle.NeverBlink;
                epErrorProvider.SetError(cbSerialPort, "No serial port is selected, or no PHCC device is detected on the selected serial port.");
            }
        }
        ...
        private void tbServo1Position_Scroll(object sender, EventArgs e)
        {
            ...
            RenderNeedleGauge(pbServo1, (int)tbServo1Position.Value, 0, 255,180);
            SendDoa8ServoValues();
        }
        ...
        {
            SendDoa8ServoGain((byte)1, (byte)nudServo1Gain.Value);
        }
        private void SendDoa8ServoGainChannel2()
        {
            SendDoa8ServoGain((byte)2, (byte)nudServo2Gain.Value);
        }
        private void SendDoa8ServoGainChannel3()
        {
            SendDoa8ServoGain((byte)3, (byte)nudServo3Gain.Value);
        }
        private void SendDoa8ServoGainChannel4()
        {
            SendDoa8ServoGain((byte)4, (byte)nudServo4Gain.Value);
        }
        private void SendDoa8ServoGainChannel5()
        {
            SendDoa8ServoGain((byte)5, (byte)nudServo5Gain.Value);
        }
        private void SendDoa8ServoGainChannel6()
        {
            SendDoa8ServoGain((byte)6, (byte)nudServo6Gain.Value);
        }
        private void SendDoa8ServoGainChannel7()
        {
            SendDoa8ServoGain((byte)7, (byte)nudServo7Gain.Value);
        }
        private void SendDoa8ServoGainChannel8()
        {
            SendDoa8ServoGain((byte)8, (byte)nudServo8Gain.Value);
        }
        ...
        private void tbServo2Position_Scroll(object sender, EventArgs e)
        {
            ...
            RenderNeedleGauge(pbServo2, (int)tbServo2Position.Value, 0, 255,180);
            SendDoa8ServoValues();
        ...
        private void tbServo3Position_Scroll(object sender, EventArgs e)
        {
            ...
            RenderNeedleGauge(pbServo3, (int)tbServo3Position.Value, 0, 255,180);
            SendDoa8ServoValues();
        ...
        private void tbServo4Position_Scroll(object sender, EventArgs e)
        {
            ...
            RenderNeedleGauge(pbServo4, (int)tbServo4Position.Value, 0, 255,180);
            SendDoa8ServoValues();
        }
        ...
        private void tbServo5Position_Scroll(object sender, EventArgs e)
        {
            ...
            RenderNeedleGauge(pbServo5, (int)tbServo5Position.Value, 0, 255,180);
            SendDoa8ServoValues();
        ...
        private void tbServo6Position_Scroll(object sender, EventArgs e)
        {
            ...
            RenderNeedleGauge(pbServo6, (int)tbServo6Position.Value, 0, 255,180);
            SendDoa8ServoValues();
        ...
        private void tbServo7Position_Scroll(object sender, EventArgs e)
        {
            ...
            RenderNeedleGauge(pbServo7, (int)tbServo7Position.Value, 0, 255,180);
            SendDoa8ServoValues();
        ...
        private void tbServo8Position_Scroll(object sender, EventArgs e)
        {
            ...
            RenderNeedleGauge(pbServo8, (int)tbServo8Position.Value, 0, 255,180);
            SendDoa8ServoValues();
