...
namespace SimLinkup
{
    ...
    public static class Program
    {
        ...
        public static void Main()
        {
            ...
            if (SimLinkup.Properties.Settings.Default.UpgradeNeeded)
            {
                try
                {
                    SimLinkup.Properties.Settings.Default.Upgrade();
                    SimLinkup.Properties.Settings.Default.UpgradeNeeded = false;
                    SimLinkup.Properties.Settings.Default.Save();
                }
                catch (Exception e)
                {
                    SimLinkup.Properties.Settings.Default.Reset();
                    SimLinkup.Properties.Settings.Default.UpgradeNeeded = false;
                    SimLinkup.Properties.Settings.Default.Save();
