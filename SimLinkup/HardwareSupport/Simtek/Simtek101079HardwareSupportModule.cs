...
namespace SimLinkup.HardwareSupport.Simtek
{
    ...
    public class Simtek101079HardwareSupportModule : HardwareSupportModuleBase, IDisposable
    {
        ...
        {
            get { return "Simtek P/N 10-1079 - Standby Compass"; }
        }

        public static IHardwareSupportModule[] GetInstances()
        {
            var toReturn = new List<IHardwareSupportModule>();
            toReturn.Add(new Simtek101079HardwareSupportModule());
            try
            {
                var hsmConfigFilePath = Path.Combine(Util.ApplicationDirectory,
                    "Simtek101079HardwareSupportModule.config");
                var hsmConfig =
                    Simtek101079HardwareSupportModuleConfig.Load(hsmConfigFilePath);
            }
            catch (Exception e)
            {
        ...
        private AnalogSignal CreateCompassSINOutputSignal()
        {
            ...
            thisSignal.Id = "101079_Compass__SIN_To_Instrument";
            thisSignal.Index = 0;
        ...
        private AnalogSignal CreateCompassCOSOutputSignal()
        {
            ...
            thisSignal.Id = "101079_Compass__COS_To_Instrument";
            thisSignal.Index = 0;
            thisSignal.Source = this;
            thisSignal.SourceFriendlyName = FriendlyName;
            thisSignal.SourceAddress = null;
        ...
        private AnalogSignal CreateCompassInputSignal()
        {
            ...
            thisSignal.Id = "101079_Compass__Magnetic_Heading_From_Sim";
            thisSignal.Index = 0;
            thisSignal.Source = this;
            thisSignal.SourceFriendlyName = FriendlyName;
            thisSignal.SourceAddress = null;
