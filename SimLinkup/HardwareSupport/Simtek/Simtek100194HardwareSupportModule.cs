...
namespace SimLinkup.HardwareSupport.Simtek
{
    ...
    public class Simtek100194HardwareSupportModule:HardwareSupportModuleBase, IDisposable
    {
        ...
        private static ILog _log = LogManager.GetLogger(typeof(Simtek100194HardwareSupportModule));
        #endregion

        #region Instance variables
        private bool _isDisposed=false;
        private AnalogSignal _machInputSignal= null;
        private AnalogSignal.AnalogSignalChangedEventHandler _machInputSignalChangedEventHandler = null;
        private AnalogSignal _machOutputSignal = null;

        private AnalogSignal _airspeedInputSignal = null;
        private AnalogSignal.AnalogSignalChangedEventHandler _airspeedInputSignalChangedEventHandler = null;
        private AnalogSignal _airspeedOutputSignal = null;

        #endregion

        #region Constructors
        private Simtek100194HardwareSupportModule():base()
        {
            CreateInputSignals();
            CreateOutputSignals();
        ...
        public override string FriendlyName
        {
            get
            {
                return "Simtek P/N 10-0194 - Indicator, Simulated Mach Airspeed";
            }
        }
        public static IHardwareSupportModule[] GetInstances()
        {
            ...
            try
            {
                string hsmConfigFilePath = Path.Combine(Util.ApplicationDirectory, "Simtek100194HardwareSupportModule.config");
                Simtek100194HardwareSupportModuleConfig hsmConfig = Simtek100194HardwareSupportModuleConfig.Load(hsmConfigFilePath);
            }
            catch (Exception e)
            {
        ...
        public override AnalogSignal[] AnalogInputs
        {
            get 
            {
                return new AnalogSignal[] { _machInputSignal, _airspeedInputSignal };
            }
        }
        ...
        public override AnalogSignal[] AnalogOutputs
        {
            get
            {
                return new AnalogSignal[] { _machOutputSignal, _airspeedOutputSignal };
            }
        }
        ...
        {
            _machInputSignalChangedEventHandler = new AnalogSignal.AnalogSignalChangedEventHandler(mach_InputSignalChanged);
            _airspeedInputSignalChangedEventHandler = new AnalogSignal.AnalogSignalChangedEventHandler(airspeed_InputSignalChanged);
        }
        ...
        private AnalogSignal CreateMachOutputSignal()
        {
            ...
            thisSignal.Id = "100194_Mach_To_Instrument";
            thisSignal.Index = 0;
        ...
        private AnalogSignal CreateAirspeedOutputSignal()
        {
            ...
            thisSignal.Id = "100194_Airspeed_To_Instrument";
            thisSignal.Index = 0;
            thisSignal.Source = this;
            thisSignal.SourceFriendlyName = this.FriendlyName;
            thisSignal.SourceAddress = null;
        ...
        private AnalogSignal CreateMachInputSignal()
        {
            ...
            thisSignal.Id = "100194_Mach_From_Sim";
            thisSignal.Index = 0;
            thisSignal.Source = this;
            thisSignal.SourceFriendlyName = this.FriendlyName;
            thisSignal.SourceAddress = null;
        ...
        private AnalogSignal CreateAirspeedInputSignal()
        {
            ...
            thisSignal.Id = "100194_Airspeed_From_Sim";
            thisSignal.Index = 0;
            thisSignal.Source = this;
            thisSignal.SourceFriendlyName = this.FriendlyName;
            thisSignal.SourceAddress = null;
        ...
        private void UpdateMachOutputValues()
        {
            if (_machInputSignal != null)
            {
                double machInput = _machInputSignal.State;
        ...
        private void UpdateAirspeedOutputValues()
        {
            if (_airspeedInputSignal != null)
            {
                double airspeedInput = _airspeedInputSignal.State;
