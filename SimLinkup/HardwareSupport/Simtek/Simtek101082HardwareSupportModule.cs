...
namespace SimLinkup.HardwareSupport.Simtek
{
    ...
    public class Simtek101082HardwareSupportModule:HardwareSupportModuleBase, IDisposable
    {
        ...
        private static ILog _log = LogManager.GetLogger(typeof(Simtek101082HardwareSupportModule));
        #endregion
        ...
        #region Constructors
        private Simtek101082HardwareSupportModule():base()
        {
            CreateInputSignals();
            CreateOutputSignals();
        ...
        public override string FriendlyName
        {
            get
            {
                return "Simtek P/N 10-1082 - Airspeed/Mach Ind";
            }
        }
        public static IHardwareSupportModule[] GetInstances()
        {
            ...
            try
            {
                string hsmConfigFilePath = Path.Combine(Util.ApplicationDirectory, "Simtek101082HardwareSupportModule.config");
                Simtek101082HardwareSupportModuleConfig hsmConfig = Simtek101082HardwareSupportModuleConfig.Load(hsmConfigFilePath);
            }
            catch (Exception e)
            {
