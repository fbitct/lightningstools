        ...
        public IEnumerable<Blip> Translate(FalconRWRSymbol falconRWRSymbol,bool primarySymbol)
        {
            ...
            switch (falconRWRSymbol.SymbolID)
            {
                ...
                case 23: //A with .. underneath
                    blips.Add(new Blip { Symbol = Symbols.A, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.Dot, X = (byte)(x - charSpacingHalfXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Dot, X = (byte)(x + charSpacingHalfXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                ...
                case 35: //airborne threat symbol with 14 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.One, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Four, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                case 36://airborne threat symbol with 15 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.One, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Five, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                case 37://airborne threat symbol with 16 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.One, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Six, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                case 38: //airborne threat symbol with 18 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.One, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Eight, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                case 39: //airborne threat symbol with 19 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.One, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Nine, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                case 40: //airborne threat symbol with 20 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.Two, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Zero, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                case 41: //airborne threat symbol with 21 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.Two, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.One, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                case 42: //airborne threat symbol with 22 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.Two, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Two, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                case 43: //airborne threat symbol with 23 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.Two, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Three, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                ...
                case 45: //airborne threat symbol with 27 inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.Two, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.Seven, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
                ...
                case 50: //airborne threat symbol with PD inside
                    blips.Add(new Blip { Symbol = Symbols.Hat, X = x, Y = y });
                    blips.Add(new Blip { Symbol = Symbols.P, X = x, Y = (byte)(y + lineSpacingYOffset) });
                    blips.Add(new Blip { Symbol = Symbols.D, X = (byte)(x + charSpacingXOffset), Y = (byte)(y + lineSpacingYOffset) });
                    break;
